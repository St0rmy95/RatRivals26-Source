...
namespace XmlRpc {
  ...
  static const char STRING_ETAG[]    = "</string>";		// 2013-03-13 by hskim, 웹 캐시 상점
  ...
  {
    std::string xml = VALUE_TAG;
    xml += STRING_TAG; // optional		// 2013-03-13 by hskim, 웹 캐시 상점
    xml += XmlRpcUtil::xmlEncode(*_value.asString);
    xml += STRING_ETAG;		// 2013-03-13 by hskim, 웹 캐시 상점
    xml += VALUE_ETAG;
    return xml;
  }
