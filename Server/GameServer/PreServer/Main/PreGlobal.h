...
#ifndef  S_AUTHENTICATION_SERVER_HSKIM		// 2011-01-26 by hskim, 인증 서버 구현
#define MasangPreServerIP		"127.0.0.1"		// 인증서버 Domain
...
public:
	...
	virtual BOOL ReLoadConfiguration(void);				// 2013-03-14 by jhseol, 버전인포 리로드 시 접속 허용 IP리스트도 갱신
...
protected:
	...
	vector<vector<string> >	m_AllowedIPList_ReloadVersion;	// 2013-03-14 by jhseol, 버전인포 리로드 시 접속 허용 IP리스트도 갱신
