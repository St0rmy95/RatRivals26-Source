...
public:
	...
	ProcessResult Process_FP_GLOG_NEW_ACCOUNT_INFO(const char* pPacket, int nLength, int &nBytesUsed);		// 2013-03-14 by bckim, Glog 기능추가
		

	///////////////////////////////////////////////////////////////////////////////
	// 2012-10-05 by jhseol, NPlay pc방 모듈
	ProcessResult Process_FP_PCBANG_USER_PREMIUM_INFO(const char* pPacket, int nLength, int &nBytesUsed);
	ProcessResult Process_FP_PCBANG_USER_PREMIUM_RESIDUAL_TIME(const char* pPacket, int nLength, int &nBytesUsed);
