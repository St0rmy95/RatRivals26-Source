...
void CGameEventManager::InitEventManager(CFieldIOCP *i_pFIOCP)
{
	...
	MEMSET_ZERO(m_arrGameEvent, sizeof(m_arrGameEvent[0][0])*INFLUENCE_TYPE_COUNT*GAME_EVENT_TYPE_MAX_COUNT);
	MEMSET_ZERO(m_arrGameEventofMotherShip, sizeof(m_arrGameEventofMotherShip[0][0])*INFLUENCE_TYPE_COUNT*GAME_EVENT_TYPE_MAX_COUNT);	// 2008-05-20 by cmkwon, 모든 이벤트(HappyHoure,MotherShip,Item) 그룹 동시에 가능하게 - 
	MEMSET_ZERO(m_arrGameEventofItem, sizeof(m_arrGameEventofItem[0][0])*INFLUENCE_TYPE_COUNT*GAME_EVENT_TYPE_MAX_COUNT);				// 2008-05-20 by cmkwon, 모든 이벤트(HappyHoure,MotherShip,Item) 그룹 동시에 가능하게 - 
	MEMSET_ZERO(m_arrGameEventofCrystal, sizeof(m_arrGameEventofCrystal[0][0])*INFLUENCE_TYPE_COUNT*GAME_EVENT_TYPE_MAX_COUNT);				// 2011-10-28 by hskim, EP4 [트리거 시스템] - 크리스탈 시스템
	MEMSET_ZERO(m_arrGameEventofCrystal2ND, sizeof(m_arrGameEventofCrystal2ND[0][0])*INFLUENCE_TYPE_COUNT*GAME_EVENT_TYPE_MAX_COUNT);	// 2011-10-28 by hskim, EP4 [트리거 시스템] - 크리스탈 시스템
...
// 	}
	...
	MEMSET_ZERO(m_PCBangGameEvent, sizeof(m_PCBangGameEvent[0])*GAME_EVENT_TYPE_MAX_COUNT);
	for(i=0; i < GAME_EVENT_TYPE_MAX_COUNT; i++)
	{
...
// 	if(i_eventType == GAME_EVENT_TYPE_DROP_ITEM && IS_IN_RANGE(101, i_nLevel, 110))	{
...
// End. 2014-06-20 by bckim, 해피아워 이벤트 하드코딩 제거 - 주석처리
	...
	if(pGameEv
		&& IS_IN_RANGE(pGameEv->MinLevel, i_nLevel, pGameEv->MaxLevel))			// 2008-03-14 by dhjin, Level별 해피아워 이벤트 구현 -
	{
		fRetPlusRate += pGameEv->fApplyRate;
	}
	...
	if(pGameEv
		&& IS_IN_RANGE(pGameEv->MinLevel, i_nLevel, pGameEv->MaxLevel))
	{
		fRetPlusRate += pGameEv->fApplyRate;
	}
...
float CGameEventManager::GetHPRecoveryRate(BYTE i_byInflType, BOOL i_bPCBangClient, INT i_nLevel, MapIndex_t i_MapIndex /*=0*/)		
{
	return CGameEventManager::GetTotalEventPlusRate(GAME_EVENT_TYPE_HP_RECOVERY, i_byInflType, i_bPCBangClient, i_nLevel, i_MapIndex);		
}

float CGameEventManager::GetSHDRecoveryRate(BYTE i_byInflType, BOOL i_bPCBangClient, INT i_nLevel, MapIndex_t i_MapIndex /*=0*/)		
{
	return CGameEventManager::GetTotalEventPlusRate(GAME_EVENT_TYPE_SHD_RECOVERY, i_byInflType, i_bPCBangClient, i_nLevel, i_MapIndex);		
}

float CGameEventManager::GetSPRecoveryRate(BYTE i_byInflType, BOOL i_bPCBangClient, INT i_nLevel, MapIndex_t i_MapIndex /*=0*/)		
{
	return CGameEventManager::GetTotalEventPlusRate(GAME_EVENT_TYPE_SP_RECOVERY, i_byInflType, i_bPCBangClient, i_nLevel, i_MapIndex);		
}

float CGameEventManager::GetWeapontEnchantRate(BYTE i_byInflType, BOOL i_bPCBangClient, INT i_nLevel, MapIndex_t i_MapIndex /*=0*/)		
{
	return CGameEventManager::GetTotalEventPlusRate(GAME_EVENT_TYPE_WEAPON_ENCHANT, i_byInflType, i_bPCBangClient, i_nLevel, i_MapIndex);		
}

float CGameEventManager::GetArmorEnchantRate(BYTE i_byInflType, BOOL i_bPCBangClient, INT i_nLevel, MapIndex_t i_MapIndex /*=0*/)		
{
	return CGameEventManager::GetTotalEventPlusRate(GAME_EVENT_TYPE_ARMOR_ENCHANT, i_byInflType, i_bPCBangClient, i_nLevel, i_MapIndex);		
}

float CGameEventManager::GetETCItemEnchantRate(BYTE i_byInflType, BOOL i_bPCBangClient, INT i_nLevel, MapIndex_t i_MapIndex /*=0*/)		
{
	return CGameEventManager::GetTotalEventPlusRate(GAME_EVENT_TYPE_ETC_ENCHANT, i_byInflType, i_bPCBangClient, i_nLevel, i_MapIndex);		
}

float CGameEventManager::GetSPIDiscountRate(BYTE i_byInflType, BOOL i_bPCBangClient, INT i_nLevel, MapIndex_t i_MapIndex /*=0*/)		
{
	return CGameEventManager::GetTotalEventPlusRate(GAME_EVENT_TYPE_SPI_DISCOUNT, i_byInflType, i_bPCBangClient, i_nLevel, i_MapIndex);		
}

float CGameEventManager::GetWPDiscountRate(BYTE i_byInflType, BOOL i_bPCBangClient, INT i_nLevel, MapIndex_t i_MapIndex /*=0*/)		
{
	return CGameEventManager::GetTotalEventPlusRate(GAME_EVENT_TYPE_WP_DISCOUNT, i_byInflType, i_bPCBangClient, i_nLevel, i_MapIndex);		
}
