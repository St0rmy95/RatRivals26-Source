...
public:
	...
	void CheckMonthlyArmorEventCollection(CFieldIOCPSocket* i_pSock, COLLECTION_INFO* io_pCollectioninfo);	// 2013-09-06 by jhseol, 이달의 아머 이벤트 적용 기간 변경	// 2013-05-31 by jhseol,bckim 아머 컬렉션 - 하나의 컬렉션에 대하여 이달의 어머 이벤트 정보 보내기
