...
//	void StartGuildWar(UID32_t DefenderGuildUID, UID32_t ChallengerGuildUID);
	...
	///////////////////////////////////////////////////////////////////////////////
	// 2007-08-02 by cmkwon, 여단 마크 심사 시스템 구현 - 
	static BOOL IsJudgeGuildMark(void);
	...
	UINT GetRandInt32(UINT i_uiMin, UINT i_uiMax);				// 2008-06-04 by dhjin, EP3 랜덤 함수 추가
