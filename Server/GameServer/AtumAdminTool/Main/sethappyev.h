...
// Dialog Data
	...
	float	m_ctlfHPRecoveryRate;
	float	m_ctlfSHDRecoveryRate;
	float	m_ctlfSPRecoveryRate;
	float	m_ctlfWeaponEnchantRate;
	float	m_ctlfArmorEnchantRate;
	float	m_ctlfETCItemEnchantRate;
	float	m_ctlfSPIDiscountRate;
	float	m_ctlfWPDiscountRate;
