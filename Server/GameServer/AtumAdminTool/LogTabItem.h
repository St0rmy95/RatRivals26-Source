...
// Dialog Data
	...
	BOOL	m_bCheckDissolution; // 2013-11-20 by jekim, 조합, 융해 툴에서 볼 수 있게 수정.
	BOOL	m_bCheckMix; // 2013-11-20 by jekim, 조합, 융해 툴에서 볼 수 있게 수정.
	//}}AFX_DATA
...
public:
	...
	BOOL GetLogAndInsertToGrid(BYTE T1_LogType, LPCSTR szTableName, LPCSTR szContentString);

	ez_map<INT, ITEM>		m_mapItemInfo;
	ez_map<string, ITEM>	m_mapItemInfoName;

	int		m_nSelectedItemNum;
	CSystemLogManager SystemLog;	// 2013-11-27 by jhseol, 베트남 디버깅용 날 퀴리 txt 파일로 생성
...
protected:
	...
	afx_msg void OnGridDClick(NMHDR *pNotifyStruct, LRESULT* pResult);		// 2014-01-23 by jhseol, 어드민 툴 로그조회 캐나다 요청 편의기능 추가
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
