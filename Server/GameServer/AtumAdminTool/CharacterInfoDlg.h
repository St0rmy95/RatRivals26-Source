...
// Dialog Data
	...
	UID32_t	m_GuildUniqueNumber;		// 2014-02-11 by bckim, 세력초기화시 정보 동기화처리	
...
// Overrides
	...
	CAtumAdminToolDlg		*m_pMainDlg;				// 2014-01-21 by jekim, 툴에서 캐릭터 삭제 가능하게 하기.
	BOOL					m_bReloadAccountInfo;		// 2014-01-21 by jekim, 툴에서 캐릭터 삭제 가능하게 하기.
// Implementation
protected:
	...
	afx_msg void OnBtnDeleteCharacter();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
