...
// Dialog Data
	...
	CTime	m_TimeEnd;
	CTime	m_TimeStart;
	BOOL	m_bCheckUserDeleteCharacterAdmin;
	//}}AFX_DATA
...
public:
	...
	BOOL GetLogAndInsertToGrid(BYTE T1_LogType, LPCSTR szTableName, LPCSTR szContentString1, LPCSTR szContentString2 = NULL);
	void SetContentsByLogType(BYTE T1_LogType, LPCSTR i_szContents1, LPCSTR i_szContents2, CString &o_szContents);
