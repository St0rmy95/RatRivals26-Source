...
-- 3. 스탯 오류 캐릭터 검색
	...
	SELECT UniqueNumber, UnitKind, Level, BonusStat, BonusStatPoint, AttackPart, DefensePart, FuelPart, SoulPart, ShieldPart, DodgePart
		FROM td_Character
	...
	INTO @CharacterUID, @UnitKind, @Level, @BonusStat, @BonusStatPoint, @AttackPart, @DefensePart, @FuelPart, @SoulPart, @ShieldPart, @DodgePart
	...
	BEGIN
		...
		SET @OrginCharStat = 6 + (@Level-1)*1 + @BonusStatPoint
