...
select top 400 accountname, charactername, level, atum.atum_GetGearString(unitkind) as unitkind, Experience, totalplaytime/3600 as PlayTime, guildname, createdtime, laststartedtime
from td_character
where race < 128 and charactername not like 'loadtest%'
...
select *
from td_character
where accountname='XORZJA'
--where charactername='Replica'
