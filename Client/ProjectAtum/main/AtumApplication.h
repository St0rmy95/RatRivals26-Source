...
class CProfiler;	// 2014-06-09 by ymjoo 프로파일러 구현
...
// 2013-10-11 by bhsohn XTrap&VTC 연동 작업
#define		USE_GAMEGUARD_XTRAP_N_VTC		8		//XTrap+VTC가드
// END 2013-10-11 by bhsohn XTrap&VTC 연동 작업
...
// 	#define		NO_GAMEGUARD
// #elif defined(LANGUAGE_CHINA) // 2009-04-15 by bhsohn 중국 XignCode사용
...
// 2015-04-13 by jwLee 일본 게임가드 삭제
//#if defined(_DEBUG) || defined(TEST140) || defined(WIKIGAMES_ENG)|| defined(LANGUAGE_CHINA)// 2012-10-22 by bhsohn 게임가드 디파인 수정
#if defined(_DEBUG) || defined(TEST140) || defined(WIKIGAMES_ENG)|| defined(LANGUAGE_CHINA) || defined(LANGUAGE_JAPAN) // 2012-10-22 by bhsohn 게임가드 디파인 수정
// end 2015-04-13 by jwLee 일본 게임가드 삭제
// 게임가드 사용안함
#define		GAMEGUARD_TYPE 					USE_GAMEGUARD_NONE
#define		NO_GAMEGUARD
...
#define		GAMEGUARD_TYPE					USE_GAMEGUARD_NONE
	// end 2011. 01. 18 by jsKim 140번 핵실드 제거 
#elif  defined(GAMEFORGE_RELEASE)
// 2015-01-07 by jwLee 게임포지 nProtector 적용
//#define		GAMEGUARD_TYPE					USE_GAMEGUARD_AHNLAB_HACKSHIELD
	// end 2009. 07. 13 by jsKim 게임포지 핵실드 적용
	#define		GAMEGUARD_TYPE 					USE_GAMEGUARD_NPROTECTOR
	#define		DEFINE_USE_GAMEGUARD_NPROTECTOR	
...
// end 2011. 1. 18 by jskim 배트남 VTC가드
	...
	// end 2010. 01. 13 by ckPark Frost게임가드 2009.11.10일자 업데이트

	#include "shieldSecurity.h"
	#include "shieldSecurityDll.h"
// 2010. 11. 05 by jskim 게임가드 적용 (아르헨티나)
...
// 2012-10-22 by bhsohn 게임가드 디파인 수정
...
//	void FieldSocketCurrentPetSocketData(MSG_FC_ITEM_PET_SOCKETDATA* pMsg);		   //2011-10-06 by jhahn 파트너 성장형 시스템
	...
	void FieldSocketInfluenceShowInfo(MSG_FC_INFLUENCE_SHOW_INFO* pMsg);		// 2014-06-18 by ymjoo 화면 상단에 세력 표시

	void FieldSocketNGCWarDisplay(MSG_NGCSPWAR_DISPLAY* pMsg);				   // 2013-08-28 by ssjung 거점전 리뉴얼(NGC)

	void FieldSocketChracterPayContributionPoint(MSG_FC_CHARACTER_PAY_CONTRIBUTIONPOINT* pMsg); // 2013-10-10 by ssjung, 거점전 리뉴얼 - 세력포인트 비율 변경
...
// 2014-01-15 by ssjung 파괴 경매장 구현
	...
	void FieldSocketDestroyAuctionNotiStart();						// 2014-06-12 by ymjoo 파괴 경매장 추가작업
	void FieldSocketDestroyAuctionNotiEnd();
// end 2014-01-15 by ssjung 파괴 경매장 구현

	void FieldSocketBugtrapSeverInfo(SBUGTRAP_SERVER_INFO* pMsg);	// 2014-02-10 by ssjung, 버그 트랩

	void FieldSocketItemUseCardItemChangeInfluenceNotify(MSG_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE_NOTIFY* pMsg);	// 2014-06-10 by ymjoo 세력 변경 아이템
...
private:
	...
	void TradeItemCenterLockFree();														 // 2013-11-29 by ssjung 거래소 구현
...
// 2007-11-20 by bhsohn 맵로딩 하는 방식 변경
	...
	void CityShopLock(BOOL bState);		// 2014-07-04 by ymjoo 상점 아이템이 여러번 구입되는 현상 수정
...
public:
	...
	BOOL						m_bArgcTestServer;			// Launcher에서 알려주는 Test서버 여부
	...
	// 2015-02-03 by jwLee nProtect 메세지 에러메세지 출력
	// 2009-01-28 by bhsohn nProtector 게임 가드 추가	
#if defined(DEFINE_USE_GAMEGUARD_NPROTECTOR)
	char				m_strMsgHackError[SIZE_MAX_ERROR_CHAT_MESSAGE];
	int					m_bMsgHackError;
#endif
	// end 2009-01-28 by bhsohn nProtector 게임 가드 추
	// end 2015-02-03 by jwLee nProtect 메세지 에러메세지 출력
	...
	SBUGTRAP_SERVER_INFO	m_strBugtrapSeverInfo;		// 2014-02-10 by ssjung, 버그 트랩

	CProfiler*			m_pProfiler;					// 2014-06-09 by ymjoo 프로파일러 구현

	bool				m_bDamageSysMessagePrint;	// 2014-12-19 by jwLee "/데미지출력" 명령어 추가
...
//	BOOL						m_bCashShopFlag;		// 캐쉬샵 플레그
	...
	// 2013-05-07 by bhsohn 웹캐쉬 상점 인증키 추가
	char		m_chAuthenticationKey[SIZE_MAX_WEB_AUTHENTICATION_KEY];  // 2013-03-13 by hskim, 웹 캐시 상점
	// END 2013-05-07 by bhsohn 웹캐쉬 상점 인증키 추가
	...
	BYTE				m_SuperiorInfluenceType;	// 2014-06-18 by ymjoo 화면 상단에 세력 표시
};
