// ShuttleChild.h: interface for the CShuttleChild class.
//
//////////////////////////////////////////////////////////////////////
...
//	BYTE		ArrDestParameter[SIZE_MAX_DESPARAM_COUNT_IN_ITEM]; // ITEM에 DesParam 필드 개수 8개로 늘리기 - 
	DestParam_t		ArrDestParameter[SIZE_MAX_DESPARAM_COUNT_IN_ITEM]; // ITEM에 DesParam 필드 개수 8개로 늘리기 - 
	// END 2013-03-27 by bhsohn DestParam 자료형 수정
	float		ArrParameterValue[SIZE_MAX_DESPARAM_COUNT_IN_ITEM]; // ITEM에 DesParam 필드 개수 8개로 늘리기 - 
...
public :	// Inline Process.
	...
	BOOL GetMoving();									// 2013-10-18 by ssjung A기어가 시즈모드 이거나 움직일때 인터페이스 띄우지 않도록 수정
...
//	LPDIRECT3DVERTEXBUFFER9 m_pMirrorVB;
	...
	BOOL					m_bShowInterface;		// 2013-10-18 by ssjung A기어가 시즈모드 이거나 움직일때 인터페이스 띄우지 않도록 수정

	BOOL					m_bToggleKeyS;			// 2014-09-04 by ymjoo S키 토글
};
