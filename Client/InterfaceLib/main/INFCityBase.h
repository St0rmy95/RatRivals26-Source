...
//	CINFImageEx* LoadNPCImage(int nNPCIndex);	//AO 2022 Shop images - unused?
	...
	void RenderBuildingItemTradeCenter(CINFBase* pShop);			// 2013-11-29 by ssjung 거래소 구현
	
	void LeaveBuildingNPC() { m_pCurrentBuildingNPC = NULL; }	// 2014-01-14 by ymjoo 워프 상점 툴팁이 남아있는 현상 수정
