...
#define OK_CANCEL_BUTTON			_Q_PARTY_INVITE == m_nMsgType ||			\
									...
									_Q_MISSON_FREEPASS_ITEM == m_nMsgType		||	\
									_Q_MARKET_ADD_ITEM == m_nMsgType		||	\
									_Q_MARKET_BUY_ITEM == m_nMsgType		||	\
									_Q_MARKET_GET_ITEM == m_nMsgType		||	\
									_Q_SETTING_SOCKET_OKCANCLE == m_nMsgType	||	\
									_Q_CAPSULE_CASH_ITEM_MESSAGE == m_nMsgType	||	\
									_Q_CHANGE_INFLUENCE_MESSAGE == m_nMsgType
									//2011-10-06 by jhahn 파트너 성장형 시스템
									// 2012-08-13 by mspark, 인벤토리 자동 정렬 확인창 추가 작업 - _Q_INVEN_ITEM_SORT 추가
									// 2013-04-23 by ssjung 중요 아이템 삭제시 2차 경고(질문) 팝업창 구현 - // _Q_INCHANT_ITEM_DELETE							
									// 2013-08-27 by bhsohn 미션 프리 패스 시스템 // _Q_MISSON_FREEPASS_ITEM
									// 2013-11-29 by ssjung 거래소 구현 //_Q_MARKET_ADD_ITEM == m_nMsgType
									// 2013-11-29 by ssjung 거래소 구현  _Q_MARKET_BUY_ITEM
									// 2013-11-29 by ssjung 거래소 구현  _Q_MARKET_GET_ITEM
									// 2014-02-07 by ymjoo 캡슐형 캐시 아이템 경고 메세지	_Q_CAPSULE_CASH_ITEM_MESSAGE
									// 2014-06-10 by ymjoo 세력 변경 아이템	_Q_CHANGE_INFLUENCE_MESSAGE
...
#define	OK_BUTTON					_MESSAGE == m_nMsgType				||		\
									...
									// 2013-11-29 by ssjung 거래소 구현  _Q_MARKET_NORMAL_MESSAGE 
...
#define INPUT_MSG_BUTTON			_Q_PARTY_INVITE_USER == m_nMsgType ||		\
									...
									_Q_USEITEM_LEADER_BAN_WARP== m_nMsgType		||		\
									_Q_PARTNER_NEW_NAME_CHANGE == m_nMsgType	
									// 2013-09-02 by ssjung 필드이동금지아이템 - _Q_USEITEM_LEADER_BAN_WARP
...
#define SINGLE_MSGBOX				_Q_TRADE_INPUT_NAME == nType		||		\
									...
									_Q_USEITEM_LEADER_BAN_WARP == nType		||	\
									_Q_MISSON_FREEPASS_ITEM == nType		||	\
									_Q_MARKET_ADD_ITEM == nType				||	\
									_Q_MARKET_BUY_ITEM == nType				||	\
									_Q_MARKET_GET_ITEM == nType				||	\
									_Q_MARKET_NORMAL_MESSAGE == nType		||	\
									_Q_CAPSULE_CASH_ITEM_MESSAGE == nType	||	\
									_Q_CHANGE_INFLUENCE_MESSAGE == nType
									// 2012-08-13 by mspark, 인벤토리 자동 정렬 확인창 추가 작업 - _Q_INVEN_ITEM_SORT 추가
									// 2013-04-23 by ssjung 중요 아이템 삭제시 2차 경고(질문) 팝업창 구현 - // _Q_INCHANT_ITEM_DELETE	
									// 2013-08-27 by bhsohn 미션 프리 패스 시스템		_Q_MISSON_FREEPASS_ITEM
									// 2013-09-02 by ssjung 필드이동금지아이템 - _Q_USEITEM_LEADER_BAN_WARP
									// 2013-11-29 by ssjung 거래소 구현 //_Q_MARKET_ADD_ITEM == m_nMsgType
									// 2013-11-29 by ssjung 거래소 구현  _Q_MARKET_BUT_ITEM
									// 2013-11-29 by ssjung 거래소 구현  _Q_MARKET_GET_ITEM
									// 2013-11-29 by ssjung 거래소 구현  _Q_MARKET_NORMAL_MESSAGE
									// 2014-02-07 by ymjoo 캡슐형 캐시 아이템 경고 메세지	_Q_CAPSULE_CASH_ITEM_MESSAGE
									// 2014-06-10 by ymjoo 세력 변경 아이템	_Q_CHANGE_INFLUENCE_MESSAGE
...
#define COMPARE_SINGLE_MSGBOX		_Q_TRADE_INPUT_NAME == (*it)->m_nMsgType	||\
									...
									_Q_USEITEM_LEADER_BAN_WARP == (*it)->m_nMsgType		||	\
									_Q_MISSON_FREEPASS_ITEM == (*it)->m_nMsgType		||	\
									_Q_MARKET_ADD_ITEM ==  == (*it)->m_nMsgType			||	\
									_Q_MARKET_BUY_ITEM == (*it)->m_nMsgType				||	\
									_Q_MARKET_GET_ITEM == (*it)->m_nMsgType				||	\
									_Q_MARKET_NORMAL_MESSAGE == (*it)->m_nMsgType		||	\
									_Q_CAPSULE_CASH_ITEM_MESSAGE == (*it)->m_nMsgType	||	\
									_Q_CHANGE_INFLUENCE_MESSAGE == (*it)->m_nMsgType
									// 2012-08-13 by mspark, 인벤토리 자동 정렬 확인창 추가 작업 - _Q_INVEN_ITEM_SORT 추가
									// 2012-10-30 by mspark, 외형 변경 경고 메시지 추가
									// 2013-04-23 by ssjung 중요 아이템 삭제시 2차 경고(질문) 팝업창 구현 - // _Q_INCHANT_ITEM_DELETE	
									// 2013-08-27 by bhsohn 미션 프리 패스 시스템		_Q_MISSON_FREEPASS_ITEM
...
//
// 2006-07-24 by ispark, 강제 메세지. 기존 메세지는 무조건 삭제(FORCED_COMPARE_SINGLE_MSGBOX에도 넣어야 한다.)
//#define FORCED_SINGLE_MSGBOX		_Q_EVENT_CALL_WARP_REQUEST == nType
//
//// 강제 메세지
//#define FORCED_COMPARE_SINGLE_MSGBOX	_Q_EVENT_CALL_WARP_REQUEST == (*it)->m_nMsgType
//
//// 강제 메세지라도 이 메세지에서는 무효 
//#define NOT_FORCED_COMPARE_SINGLE_MSGBOX	_Q_INPUT_SERIAL_NUM == (*it)->m_nMsgType	||		\
//											_Q_MEMBER_SUMMON == (*it)->m_nMsgType		||		\
//											_Q_QUIT_MESSAGE == (*it)->m_nMsgType		||		\
//											_Q_USEITEM_NAME_CHANGE == (*it)->m_nMsgType ||		\
//											_Q_DEAD_RETURN == (*it)->m_nMsgType			||		\
//											_Q_SKILL_CALLOFHERO	== (*it)->m_nMsgType	||		\
//											_Q_FUELALLIN_DEAD_RETURN == (*it)->m_nMsgType ||	\
//											_Q_INFLUENCEMAP_DEAD_RETURN == (*it)->m_nMsgType ||	\
//											_Q_USE_NORMAL_RESTORE == (*it)->m_nMsgType	||		\
//											_Q_BAZAAR_OPEN_SHOP_END == (*it)->m_nMsgType	||	\
//											_Q_ARENA_WARP == (*it)->m_nMsgType
	

#define ENTER_MSGBOX				_Q_SHOP_SELL_ITEM	== m_nMsgType	||		\
									_Q_SHOP_MULTI_SELL_ITEM == m_nMsgType ||	\
									_Q_STORE_MULTI_PUT_ITEM == m_nMsgType ||	\
									_Q_STORE_MULTI_GET_ITEM == m_nMsgType ||	\
									_Q_ITEM_DELETE_NUM == m_nMsgType	||		\
									_Q_PARTY_INVITE_USER == m_nMsgType	||		\
									_Q_TRADE_ITEM_NUMBER == m_nMsgType	||		\
									_Q_SHOP_SELL_ENERGY == m_nMsgType	||		\
									_Q_TRADE_INPUT_NAME == m_nMsgType	||		\
									_Q_GUILD_CREATE == m_nMsgType		||		\
									_Q_GUILD_INVITE == m_nMsgType		||		\
									_Q_GUILD_MARK == m_nMsgType			||		\
									...
									_Q_VOIP_USING					== m_nMsgType
									// 2013-09-02 by ssjung 필드이동금지아이템 - _Q_USEITEM_LEADER_BAN_WARP
									// 2014-09-12 by ymjoo 유저 편의성 메세지 박스 엔터키 적용
									// _MESSAGE
									// _MESSAGE_ERROR_CREATE
									// _Q_ALREADY_HAVE_ITEM
									// _Q_APPEARANCE_CHANGE_PREVENTION
									// _Q_AUCTION_DELETE_ITEM
									// _Q_AUCTION_INPUT_ITEM
									// _Q_BAZAAR_BUY_OK
									// _Q_BAZAAR_INVALID_SHOP_END
									// _Q_BAZAAR_OPEN_SHOP_END
									// _Q_BAZAAR_SELL_OK
									// _Q_BUY_INFINITYSHOP_ITEM
									// _Q_CAPSULE_CASH_ITEM_MESSAGE
									// _Q_CHATROOM_INVITE_FROM
									// _Q_CHATROOM_OUT
									// _Q_COUPON
									// _Q_DELETE_FRIEND
									// _Q_DELETE_REJECT
									...
									// _Q_GIFT_ITEM_RING_IN
									// _Q_ITEM_DELETE
									// _Q_MARKET_NORMAL_MESSAGE
									// _Q_MULTI_SEL_WARNING
									// _Q_STORE_PUT_ITEM
									// _Q_USEITEM_KILL_MARK
									// _Q_VOIP_MENU
									// _Q_VOIP_ONE_NAME
									// _Q_VOIP_USING
									// END 2014-09-12 by ymjoo 유저 편의성 메세지 박스 엔터키 적용
...
// 2013-11-29 by ssjung 거래소 구현 - 거래소 관련 메시지 박스 다른 메시지 처리 불가능 하도록 수정
#define IS_TRADE_CENTER				_Q_MARKET_ADD_ITEM == m_nMsgType	||		\
									_Q_MARKET_BUY_ITEM == m_nMsgType	||		\
									_Q_MARKET_GET_ITEM == m_nMsgType	||		\
									_Q_MARKET_NORMAL_MESSAGE == m_nMsgType

// 2013-11-29 by ssjung 거래소 구현 - 메시지 박스 가운데 정렬
#define IS_MID_SORT					_Q_MARKET_ADD_ITEM == m_nMsgType	||		\
									_Q_MARKET_BUY_ITEM == m_nMsgType	||		\
									_Q_MARKET_GET_ITEM == m_nMsgType	||		\
									_Q_MARKET_NORMAL_MESSAGE == m_nMsgType
...
#if defined(LANGUAGE_VIETNAM)|| defined(LANGUAGE_THAI)
// end 2015-05-22 by jwlee 영어권 나라에서 '\n'문자 인식을 위해 디파인 해제
...
CINFMessageBox::~CINFMessageBox()
{
	...
	SAFE_DELETE(m_pFontMessage);
	SAFE_DELETE(m_pFontInput[0]);
	SAFE_DELETE(m_pFontInput[1]);
	SAFE_DELETE(m_pFontRadio);

	// 2007-10-16 by bhsohn 특정 글씨만 볼드로 처리
	SAFE_DELETE(m_pFontBold);	
}
...
// 		sprintf(strMessageTemp, "%s %s", strText, strTime);
	...
	if(INPUT_MSG_BUTTON)
	{
// 2008-03-28 by dgwoo 메시지 박스에 스트링 길이에 따라 높이를 계산하여 메시지 박스를 그려준다.
//		if(m_nCy < 19*3 + SIZE_MSGBOX_BUTTON_Y + 22)
//			m_nCy = 19*3 + SIZE_MSGBOX_BUTTON_Y + 22;
		if(m_nCy < 19*3 + 22)
			m_nCy = 19*3 + 22;
...
//			STRING_CULL(strMsg, MESSAGE_STRING_LENGTH, &vecstrMessage, m_pFontInput[1]);
			...
			int nX = 0;							  // 2013-12-18 by ssjung MsgBox에 가운데 정렬 추가		
...
// 2013-12-18 by ssjung MsgBox에 가운데 정렬 추가
				if(IS_MID_SORT)
					nX = m_nX + (m_nCx - m_pFontMessage->GetStringSize((char*)vecstrMessage[nMessageLine].c_str()).cx)/2;
				else
					nX = m_nX + 20;
				...
				if(IS_BOLD)
				{
					...
					RenderCashMsgBox(nX, m_nY+24 + (nMessageLine * MESSAGE_FONT_LINE_HEIGHT), pTxt);

				}
				else
				{
					//m_pFontMessage->DrawText(m_nX+20, m_nY+24 + (nMessageLine * MESSAGE_FONT_LINE_HEIGHT), GUI_FONT_COLOR, (char*)vecstrMessage[nMessageLine].c_str(), 0L);
					m_pFontMessage->DrawText(nX, m_nY+24 + (nMessageLine * MESSAGE_FONT_LINE_HEIGHT),GUI_FONT_COLOR, (char*)vecstrMessage[nMessageLine].c_str(), 0L);
				}
// end 2013-12-18 by ssjung MsgBox에 가운데 정렬 추가				
			}
		}
	}
	if(OK_CANCEL_BUTTON)
...
// 			}
	...
	else if(INPUT_RADIO_BUTTON)
	{
		...
		int  nTemp = 0;
		int bSelect = 1;
		int i; for(i=0; i<m_nRadioCount; i++)
		{
	...
	case WM_MOUSEMOVE:
		{
			...
			if(m_nMsgType == _Q_SELECT_DELETE ||
				...
				_Q_RETURN_TO_PROGRESS_INFINITY	== m_nMsgType || // 2014-04-23 by ssjung 인피니티 복귀 시 메시지 박스 예외 추가
				IS_TRADE_CENTER)	// 2013-11-29 by ssjung 거래소 구현 - 거래소 관련 메시지 박스 다른 메시지 처리 불가능 하도록 수정
			{
				return INF_MSGPROC_BREAK;
			}
...
// 			   pt.x < m_nX+m_nCx-14 && pt.y < m_nY+95) // 19: title bar height
			...
			if(IS_TRADE_CENTER)	// 2013-11-29 by ssjung 거래소 구현 - 거래소 관련 메시지 박스 다른 메시지 처리 불가능 하도록 수정
			{
				return INF_MSGPROC_BREAK;
			}
		}
	...
	case WM_KEYDOWN:
		{
			...
			if(wParam == VK_RETURN)
			{
				// 2014-06-26 by ymjoo GM 한정 모든 메세지 박스 엔터(확인) 적용
#ifdef C_GM_MESSAGE_BOX_ENTER_YMJOO
...
#endif
				// END 2014-06-26 by ymjoo GM 한정 모든 메세지 박스 엔터(확인) 적용
			...
			// select, create menu시에 메시지 버림
			if( m_nMsgType == _Q_SELECT_DELETE ||				// 2013-12-19 by ssjung 캐릭터를 지울때는 다른 키입력을 막도록 수정
				((m_nMsgType == _MESSAGE_ERROR_CREATE ||
				m_nMsgType == _MESSAGE_ERROR_NETWORK ||
				_Q_RETURN_TO_PROGRESS_INFINITY	== m_nMsgType || // 2014-04-23 by ssjung 인피니티 복귀 시 메시지 박스 예외 추가
				(IS_TRADE_CENTER) ||					// 2013-11-29 by ssjung 거래소 구현 - 거래소 관련 메시지 박스 다른 메시지 처리 불가능 하도록 수정
	...
	case _Q_VOIP_NAME:
		{
			if(i == 0)
			{
				...
				strncpy(sMsg.szCalledCharacterName, m_strInputMessage, SIZE_MAX_CHARACTER_NAME);
				...
				strcpy(g_pD3dApp->m_VOIPState.szName, m_strInputMessage);
			}
			else
			{
				g_pD3dApp->m_VOIPState.nVOIPState = _VOIP_NOTLOGIN;
...
//#ifdef LANGUAGE_CHINA	
		...
		break;
	case _Q_PARTYMASTER_VOIP:
		{
			if(i == 0)
			{
				
				//ASSERT_ASSERT(g_pShuttleChild->m_pClientParty->GetPartyInfo().bPartyType == _PARTYMASTER);
				if(g_pShuttleChild->m_pClientParty->GetPartyInfo().bPartyType == _PARTYMASTER)
				{
					ASSERT_ASSERT(g_pD3dApp->m_VOIPState.nVOIPState == _VOIP_TRY_REGISTER);
					MSG_IC_VOIP_NtoN_CREATEROOM_REQUEST sMsg;
					sMsg.byIsPartyCall = TRUE;
					g_pIMSocket->SendMsg( T_IC_VOIP_NtoN_CREATEROOM_REQUEST, (char*)&sMsg, sizeof(sMsg));
//					g_pIMSocket->WriteMessageType(T_IC_VOIP_NtoN_CREATEROOM_REQUEST);
					g_pD3dApp->m_VOIPState.nCallState = _CALLSTATE_PARTY;
				}
//				else
//				{
//					g_pD3dApp->m_VOIPState.bCaller = FALSE;
	...
	case _Q_JOIN_PARTY_VOIP:
		{
			if(i == 0)
			{
					...
					g_pShuttleChild->m_pClientParty->GetPartyInfo().bPartyType != _NOPARTY)
				{
					...
					memset(&copyData, 0x00, sizeof(COPYDATASTRUCT));
					AV_MSG_WM_COPYDATA voIP(_NtoNCall, AV_MT_PARTY_JOIN_ROOM, 0);
					copyData.dwData = (DWORD)voIP;
				...
				{
					g_pD3dApp->m_pChat->CreateChatChild(STRERR_C_VOIP_0005,COLOR_VOIP,CHAT_TAB_SOUND);
				}
			}
		}
		break;
	case _Q_GUILDMASTER_VOIP:
		{
			if(i == 0)
			{
				ASSERT_ASSERT(g_pGameMain->m_pCommunity->GetGuild()->GetMyGuildRank() == GUILD_RANK_COMMANDER);
				if(g_pGameMain->m_pCommunity->GetGuild()->GetMyGuildRank() == GUILD_RANK_COMMANDER)
				{
					ASSERT_ASSERT(g_pD3dApp->m_VOIPState.nVOIPState == _VOIP_TRY_REGISTER);
					MSG_IC_VOIP_NtoN_CREATEROOM_REQUEST sMsg;
					sMsg.byIsPartyCall = FALSE;
					g_pD3dApp->m_VOIPState.nCallState = _CALLSTATE_GUILD;
					g_pIMSocket->SendMsg( T_IC_VOIP_NtoN_CREATEROOM_REQUEST, (char*)&sMsg, sizeof(sMsg));
//					g_pIMSocket->WriteMessageType(T_IC_VOIP_NtoN_CREATEROOM_REQUEST);
				}
//				else
	...
	case _Q_JOIN_GUILD_VOIP:
		{
			if(i == 0)
			{
					...
					g_pShuttleChild->m_myShuttleInfo.GuildUniqueNumber != 0)
				{
					...
					g_pD3dApp->m_VOIPState.nCallState = _CALLSTATE_GUILD;
					COPYDATASTRUCT	copyData;
					MSG_MT_GUILD_JOIN_ROOM sMsg;
					sMsg.uiGuildUniqueNumber = g_pShuttleChild->m_myShuttleInfo.GuildUniqueNumber;
					sMsg.nAccountUniqueNumber = g_pShuttleChild->m_myShuttleInfo.AccountUniqueNumber;
					strcpy( sMsg.szCharacterName, g_pShuttleChild->m_myShuttleInfo.CharacterName );

					memset(&copyData, 0x00, sizeof(COPYDATASTRUCT));
					AV_MSG_WM_COPYDATA voIP(_NtoNCall, AV_MT_GUILD_JOIN_ROOM, 0);
					copyData.dwData = (DWORD)voIP;
					copyData.lpData = &sMsg;
					copyData.cbData = sizeof(sMsg);
					::SendMessage( g_pD3dApp->m_VOIPState.m_hWndAtumVoIPClient,
				...
				{
					g_pD3dApp->m_pChat->CreateChatChild(STRERR_C_VOIP_0006,COLOR_VOIP,CHAT_TAB_SOUND);
				}
			}
		}
		break;
			...
			if(i == 0)
			{
				...
				if(strlen(m_strInputMessage) < SIZE_MAX_GUILD_NAME && strlen(m_strInputMessage) > 0)				
				{
					if(bFilter)
					{
						...
						STRNCPY_MEMSET(szGuildName, m_strInputMessage,SIZE_MAX_GUILD_NAME);						
	...
	case _Q_GUILD_CREATE_CONFIRM:
		{
			...
			{
				MSG_IC_GUILD_CREATE sMsg;
				STRNCPY_MEMSET( sMsg.GuildName, m_strInputMessage, SIZE_MAX_GUILD_NAME);
				g_pIMSocket->SendMsg( T_IC_GUILD_CREATE, (char*)&sMsg, sizeof(sMsg));
			}
		}
		break;
...
//				DBGOUT("필드서버 상황 : 워프 요청. MSG_FC_EVENT_REQUEST_WARP\n");
			}
		}
		break;
	...
	case _Q_DELETE_REJECT:
		{
			...
			{
				// 2008-04-04 by bhsohn Ep3 커뮤니티 창
				//g_pGameMain->m_pCommunity->GetReject()->m_bDeleteOK = TRUE;
				g_pGameMain->m_pCommunity->GetReject()->SendDeleteRejectList();
			}
		}
		break;
	case _Q_GUILD_VOIP_END:
		{
			if(i == 0)
			{
				...
				g_pD3dApp->m_pChat->CreateChatChild(STRMSG_C_VOIP_0019, COLOR_VOIP);//"여단통화를 종료 하였습니다."
//				DBGOUT("여단통화를 종료합니다\n");
			}
		}
		break;	
	case _Q_PARTY_VOIP_END:
		{
			if(i == 0)
			{
				MSG_IC_VOIP_NtoN_GOOUT_ALL sMsg;
				...
				g_pD3dApp->m_pChat->CreateChatChild(STRMSG_C_VOIP_0020, COLOR_VOIP);//"편대통화를 종료 하였습니다."
//				DBGOUT("편대통화를 종료합니다\n");
			}
		}
		break;
	...
	case _Q_CREATE_NICKNAME:
		{
			if(0 == i)
			{
				...
				{
					UID32_t	myCharacterUniqueNumber = myShuttleInfo.CharacterUniqueNumber;
	...
	case _Q_INFINITY_GIVE_UP:
		{
			if( i == 0 )
			{
				// 2014-09-24 by ymjoo 인피니티에서 제한시간 종료 후 포기 확인 누르면 버튼 사라지는 현상 수정
// 				g_pD3dApp->m_pInterface->m_pInfinity->SetInfinityEnd();
// 				
// 				g_pFieldWinSocket->SendMsg( T_FC_INFINITY_LEAVE, 0, 0 );
				if(g_pD3dApp->m_pInterface->m_pInfinity->IsRemainTimeLimit())
				{
					g_pD3dApp->m_pInterface->m_pInfinity->SetInfinityEnd();	
					g_pFieldWinSocket->SendMsg(T_FC_INFINITY_LEAVE, 0, 0);
				}
				// END 2014-09-24 by ymjoo 인피니티에서 제한시간 종료 후 포기 확인 누르면 버튼 사라지는 현상 수정
			}
		}
		break;
...
// 2013-04-23 by ssjung 중요 아이템 삭제시 2차 경고(질문) 팝업창 구현 - // _Q_INCHANT_ITEM_DELETE	
		...
		case _Q_MISSON_FREEPASS_ITEM:
			{
				if(i == 0)
				{
					if(g_pGameMain && g_pGameMain->m_pInven)
					{
						g_pGameMain->m_pInven->UseSendMissionFreePassItem(m_UniqueNumber);
					}					
				}
...
// 2013-09-02 by ssjung 필드이동금지아이템 - _Q_USEITEM_LEADER_BAN_WARP
		case _Q_USEITEM_LEADER_BAN_WARP:
			{
				if(i == 0)
				{
					m_strInputMessage[strlen(m_strInputMessage)-1] = NULL;// '_'문자 삭제
				}
				UseLeaderBanWarpItem(i, m_strInputMessage);			
			}
		break;
// end 2013-09-02 by ssjung 필드이동금지아이템 - _Q_USEITEM_LEADER_BAN_WARP
//2013-11-29 by ssjung 거래소 구현
		case _Q_MARKET_ADD_ITEM:
			{
#ifdef SC_MARKET_JHSEOL_BCKIM_SSJUNG
				if(i == 0)
				{
					CINFBase* pINFbase = g_pInterface->m_pCityBase->m_mapCityShop[BUILDINGKIND_AUCTION];
					CINFTradeItemAdd* pTradeAddView = ((CINFTradeItemAdd*)((CINFTradeItemCenter*)pINFbase)->GetCurrentView());
					pTradeAddView->ADDItem();
				}
#endif
			}
			break;
		case _Q_MARKET_BUY_ITEM:
			{
#ifdef SC_MARKET_JHSEOL_BCKIM_SSJUNG
				if(i == 0)
				{
					CINFBase* pINFbase = g_pInterface->m_pCityBase->m_mapCityShop[BUILDINGKIND_AUCTION];
					CINFTradeItemBuy* pTradeBuyView = ((CINFTradeItemBuy*)((CINFTradeItemCenter*)pINFbase)->GetCurrentView());
					pTradeBuyView->BuyItem();
				}
#endif
			}
			break;
		case _Q_MARKET_GET_ITEM:
			{
				if(i == 0)
				{
					MSG_FC_MARKET_GET_REQUEST sMsg;
					memset(&sMsg,0x00,sizeof(sMsg));
					
					sMsg.MarketUID = m_UniqueNumber;
					sMsg.MarketStatus = m_dwData;
					g_pFieldWinSocket->SendMsg( T_FC_MARKET_GET_REQUEST, (char*)&sMsg, sizeof(sMsg));
				}
			}
			break;
// end 2013-11-29 by ssjung 거래소 구현
		// 2014-02-07 by ymjoo 캡슐형 캐시 아이템 경고 메세지
		case _Q_CAPSULE_CASH_ITEM_MESSAGE:
			{
				if(i == 0)
				{
					ITEM_BASE* pItem = (ITEM_BASE*)(g_pStoreData->FindItemInInventoryByUniqueNumber(g_pGameMain->m_pInven->GetUseCapsuleCashItemUniqueNum()));
					g_pGameMain->m_pInven->SendUseItem(pItem);
				}
			}
			break;
		...
		case _Q_CHANGE_INFLUENCE_MESSAGE:
			{
				if(i == 0)
				{
					MSG_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE sMsg;
					sMsg.ItemUniqueNumber = g_pGameMain->m_pInven->GetUseByMessageItemUniqueNum();
					if(IS_VCN_INFLUENCE_TYPE(g_pShuttleChild->GetShuttleInfo()->InfluenceType))
						sMsg.InfluenceType = INFLUENCE_TYPE_ANI;
					else
						sMsg.InfluenceType = INFLUENCE_TYPE_VCN;
					g_pFieldWinSocket->SendMsg(T_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE, (char*)&sMsg, sizeof(sMsg));
				}
			}
			break;
...
// 2014-04-23 by ssjung 인피니티 복귀 시 메시지 박스 예외 추가
	vector<CINFMessageBox*>::iterator it = m_vecMessageBox.begin();
	while(it != m_vecMessageBox.end())
	{
...
// 2013-11-29 by ssjung 거래소 구현
#ifdef SC_MARKET_JHSEOL_BCKIM_SSJUNG		
			|| (*it)->m_nMsgType == _Q_MARKET_ADD_ITEM || (*it)->m_nMsgType == _Q_MARKET_BUY_ITEM 
			|| (*it)->m_nMsgType == _Q_MARKET_GET_ITEM || (*it)->m_nMsgType == _Q_MARKET_NORMAL_MESSAGE
#endif
// end 2013-11-29 by ssjung 거래소 구현
			)
		{
...
// end 2014-04-23 by ssjung 인피니티 복귀 시 메시지 박스 예외 추가
...
CINFWindow::~CINFWindow()
{
	FLOG( "~CINFWindow()" );
/*	//친구
	SAFE_DELETE(m_pCutdis);
	SAFE_DELETE(m_pCutOver);
	SAFE_DELETE(m_pCutPush);
	SAFE_DELETE(m_pDeldis );
	SAFE_DELETE(m_pDelOver)
	SAFE_DELETE(m_pDelPush)
	SAFE_DELETE(m_pResdis);
	SAFE_DELETE(m_pResOver);
	SAFE_DELETE(m_pResPush );
	SAFE_DELETE(m_pFriend );
	SAFE_DELETE(m_pScrol ) ;

	//거부
	SAFE_DELETE(m_pDetdis );
	SAFE_DELETE(m_pDetOver);
	SAFE_DELETE(m_pDetPush);
	SAFE_DELETE(m_pRtdis);
	SAFE_DELETE(m_pRtOver);
	SAFE_DELETE(m_pRtPush);
	SAFE_DELETE(m_pReject);
	*/


//	SAFE_DELETE(m_pGameData);
	SAFE_DELETE(m_pXclose);
	SAFE_DELETE(m_pAllBox);
	SAFE_DELETE(m_pAllButton[0]);
	SAFE_DELETE(m_pAllButton[1]);
	int i;
	for(i=0;i<9;i++)
		SAFE_DELETE(m_pBoxImage[i]);

	// 2007-11-12 by bhsohn 캐쉬아이템 메시지 박스 처리
	for(i=0;i<9;i++)
		SAFE_DELETE(m_pBoldBoxImage[i]);	
	...
	SAFE_DELETE(m_pRadioButton[0]);
	SAFE_DELETE(m_pRadioButton[1]);
	SAFE_DELETE(m_pTradeBase);
...
int CINFWindow::MsgBoxWndProc(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	while(it != m_vecMessageBox.end())
	{
		CINFMessageBox* pend = *m_vecMessageBox.end();
		CINFMessageBox* pMsgBox = *it;
...
void CINFWindow::ClearAllMessageString()
{
	...
	while(it != m_vecMessageBox.end())
	{
		int m_nMsgType = (*it)->m_nMsgType;
		if(INPUT_MSG_BUTTON || INPUT_COUNT_BUTTON)
		{			
			g_pD3dApp->m_bChatMode = FALSE;
			(*it)->ClearMessageBoxString();			
		}
	...
	case _Q_PARTY_INVITE:
		{
			...
			STRNCPY_MEMSET(szCharName, strName, SIZE_MAX_ARENA_FULL_NAME);	
...
void CINFMessageBox::UseSpeakerItem(int nNotOk, char* strInputMessage)
{
	if(0 == nNotOk)
	{
		...
		STRNCPY_MEMSET(pSMsg->str256ChatMsg, strInputMessage, SIZE_MAX_STRING_256);
...
void CINFMessageBox::UseLeaderBanWarpItem(int nNotOk, char* strInputMessage)
{
	if(0 == nNotOk)
	{
		MSG_FC_ITEM_USE_ITEM sMsg;
