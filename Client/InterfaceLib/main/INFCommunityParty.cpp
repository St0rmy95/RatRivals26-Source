...
//#define FRAME_START_Y		250//85
...
#if defined C_REMOVE_VOIP_YMJOO				// 2014-01-28 by ymjoo VoIP 기능 삭제
	// 2008-04-04 by bhsohn Ep3 커뮤니티 창
	// 배경
	#define	COMMU_BK_START_X		2
	#define	COMMU_BK_START_Y		25
	#define	COMMU_BK_START_WIDTH	100
	#define	COMMU_BK_START_HEIGHT	25

	#define	COMMU_BK_BTN_START_X	COMMU_BK_START_X + 40
	#define	COMMU_BK_BTN_START_Y	COMMU_BK_START_Y + 10
	#define	COMMU_BK_BTN_GAP		60

	#define SIZE_MAX_COM_TEAM_PW	10

	////////////////////// 편대 검색////////////////////// 
	#define	COMMU_BK_SEARCH_WIDTH	465	// 편대 검색 너비
	// 생성
	#define	CURRENT_PARTY_BTN_START_X		355
	#define	CURRENT_PARTY_BTN_START_Y		316

	#define	CURRENT_PARTY_OPTION_BTN_START_X		32
	#define	CURRENT_PARTY_OPTION_BTN_START_Y		340
	...
	#define MAX_PARTY_LIST_LINE				8

	// 셀렉트 이미지
	#define	SEL_IMAGE_POS_X					26
	#define	SEL_IMAGE_POS_Y					84
	#define	SEL_IMAGE_POS_CAP_Y				31
	////////////////////// 편대 옵션////////////////////// 
	// 초대
	...
	// 편대원 ID
	#define	PARTYOP_LIST_START_X			260
	#define	PARTYOP_LIST_START_Y			236
	#define PARTYOP_LIST_VOIP_START_X		385
	#define PARTYOP_LIST_VOIP_START_Y		236
	#define PARTYOP_LIST_HEIGHT				16
	// 2008-12-02 by bhsohn 편대원 온오프라인 상태체크
	#define	PARTYOP_LIST_ON_START_X			448
	#define	PARTYOP_LIST_ON_START_Y			236

	#define	COMMUNITY_OPBK_WIDTH			230
	#define	COMMUNITY_OPBK_HEIGHT			623

	// Edit 컨트롤 (Pass)
	#define		SECURITY_WND_PASS_EDIT_X		74
	#define		SECURITY_WND_PASS_EDIT_Y		171
	#define		SECURITY_WND_PASS_EDIT_W		85
	#define		SECURITY_WND_PASS_EDIT_H		17

	// 최소 에디트 컨트롤
	#define		MIN_NUM_EDIT_X		(56)
	#define		MIN_NUM_EDIT_Y		(205)
	#define		MIN_NUM_EDIT_W		(43)
	#define		MIN_NUM_EDIT_H		(16)

	// 최대 에디트 컨트롤
	#define		MAX_NUM_EDIT_X		(116)
	#define		MAX_NUM_EDIT_Y		(205)
	#define		MAX_NUM_EDIT_W		(43)
	#define		MAX_NUM_EDIT_H		(16)

	// 여단 소개
	#define		PARTY_NAME_EDIT_X						96
	#define		PARTY_NAME_EDIT_Y						69
	#define		PARTY_NAME_EDIT_W						150
	#define		PARTY_NAME_FONT_LINE_HEIGHT			15

	// 참여 방식 라디오
	#define	PARTYCRE_JOIN_X				46
	#define	PARTYCRE_JOIN_Y				112
	#define	PARTYCRE_JOIN_CAP_Y			18

	// 음성 옵션 라디오
	#define	PARTYCRE_AUDIO_X				46
	#define	PARTYCRE_AUDIO_Y				261
	...
	#define DIVISION_COMBO_ELE_HEIGHT			15

	// 콤보박스
	#define	PARTY_FORMAT_COMBO_MAIN_X				262
	#define	PARTY_FORMAT_COMBO_MAIN_Y				89
	#define PARTY_FORMAT_COMBO_MAIN_WIDTH			110
	#define PARTY_FORMAT_COMBO_MAIN_HEIGHT			17
	#define PARTY_FORMAT_COMBO_ELE_WIDTH			110
	#define PARTY_FORMAT_COMBO_ELE_HEIGHT			15

	// 편대 포맷 설명
	#define	COMMUNITY_FORMATTXT_X				23
	#define	COMMUNITY_FORMATTXT_Y				337
	...
	#define	COMMUNITY_FORMATION_SKILL_DESC_Y		112
	...
	// Edit 컨트롤 (Pass)
	#define		SECURITY_WND_PASS_EDIT_X		130
	#define		SECURITY_WND_PASS_EDIT_Y		148
	#define		SECURITY_WND_PASS_EDIT_W		85
	#define		SECURITY_WND_PASS_EDIT_H		17

	// 최소 에디트 컨트롤
	#define		MIN_NUM_EDIT_X		(115)
	#define		MIN_NUM_EDIT_Y		(165)
	#define		MIN_NUM_EDIT_W		(43)
	#define		MIN_NUM_EDIT_H		(16)

	// 최대 에디트 컨트롤
	#define		MAX_NUM_EDIT_X		(175)
	#define		MAX_NUM_EDIT_Y		(165)
	#define		MAX_NUM_EDIT_W		(43)
	#define		MAX_NUM_EDIT_H		(16)
...
//	}
	...
	// 2008-04-04 by bhsohn Ep3 커뮤니티 창	
	SAFE_DELETE(m_pSCrateBtn);	// 생성
	SAFE_DELETE(m_pSJoinBtn);	// 참여
	SAFE_DELETE(m_pSRefreshBtn);	// 참여	
...
HRESULT CINFCommunityParty::InitDeviceObjects()
{
	...
	int i; for(i=0;i<MAX_PARTY_NUMBER;i++)
	{
		// 2014-01-28 by ymjoo VoIP 기능 삭제
#if defined C_REMOVE_VOIP_YMJOO
		m_pPartyList[i] = new CD3DHanFont(_T(g_pD3dApp->GetFontStyle()),9, D3DFONT_ZENABLE,  FALSE,256,32);
#else
...
//	}
	...
	}
	{
		...
		m_pVOIPImage= new CINFImageEx;
		m_pVOIPImage->InitDeviceObjects( pDataHeader );
	}
	
	{
		pDataHeader = m_pGameData->Find("p_sel2");		
		m_pVOIPSpeakingImage= new CINFImageEx;
		m_pVOIPSpeakingImage->InitDeviceObjects( pDataHeader );
	}
...
//	}
	...
	if(m_pSCrateBtn)
	{
		...
		nPosX = ptBkPos.x + CURRENT_PARTY_BTN_START_X;
		nPosY = ptBkPos.y + CURRENT_PARTY_BTN_START_Y;		
...
////			{
////				int i; for(i=0;i<PARTY_FORMATION_NUMBER;i++)
////				{
	...
	case WM_LBUTTONDOWN:
		{
			...
			if(pt.y>nCheckY && pt.y<nCheckY + COMMU_BK_START_HEIGHT)
			{
				for(nCnt = 0;nCnt < MAX_WND_PARTYMODE;nCnt++)
				{
					nCheckX = ptBkPos.x + COMMU_BK_BTN_START_X + (nCnt*( COMMU_BK_START_WIDTH + COMMU_BK_BTN_GAP) );
...
void CINFCommunityParty::RenderParyInfo(POINT ptPos)
{
	...
	for(nCnt =0;nCnt < MAX_PARTY_LIST_LINE;nCnt++)
	{
		...
		nPosY = ptPos.y + SEL_IMAGE_POS_Y + (SEL_IMAGE_POS_CAP_Y *nLine) + ( 16 ) - ( tempSize.cy / 2 );
		...
		if( m_pPartyList[0]->GetStringSize(pListInfo->chPartyName).cx > 184 )
		{
			memset(chResultBuf, 0x00, 512);
			strncpy(chResultBuf, pListInfo->chPartyName, strlen(pListInfo->chPartyName)-1);
			do
			{
				chResultBuf[GetStringBuffPos(chResultBuf, GetStringBuffLen(chResultBuf)-1)] = '\0';
			} while( m_pPartyList[0]->GetStringSize(chResultBuf).cx > 172 );
		...
		{
			m_pVOIPImage->Move(nPosX - 23 - m_pVOIPImage->GetImgSize().x / 2, nPosY);
			m_pVOIPImage->Render();			
		}
...
void CINFCommunityParty::RenderPartyNumInfo()
{
...

	{
		...
		// 2014-01-28 by ymjoo 편대원 기어 정보 추가
#if defined C_PARTY_MEMBER_GEAR_YMJOO
		{
			UnitKind_t unitKind = g_pShuttleChild->m_myShuttleInfo.UnitKind;
			if(IS_BGEAR(unitKind))
				wsprintf(chBuff, "B-GEAR");
			else if(IS_MGEAR(unitKind))
				wsprintf(chBuff, "M-GEAR");
			else if(IS_AGEAR(unitKind))
				wsprintf(chBuff, "A-GEAR");
			else if(IS_IGEAR(unitKind))
				wsprintf(chBuff, "I-GEAR");
			else
				wsprintf(chBuff, "");

			SIZE levelStringSize = m_pOPartyList->GetStringSize(chBuff);

			nPosX = PARTYOP_LIST_START_X + 135 + ptBkPos.x - levelStringSize.cx/2;
			nPosY = PARTYOP_LIST_START_Y + ptBkPos.y + (nIdx*PARTYOP_LIST_HEIGHT);
...
#endif
		// END 2014-01-28 by ymjoo 편대원 기어 정보 추가
...
#if defined C_PARTY_MEMBER_GEAR_YMJOO
		{
			UnitKind_t unitKind = (*itParty)->m_ImPartyMemberInfo.UnitKind;
			if(IS_BGEAR(unitKind))
				wsprintf(chBuff, "B-GEAR");
			else if(IS_MGEAR(unitKind))
				wsprintf(chBuff, "M-GEAR");
...
void CINFCommunityParty::InitControl()
{
	...
	// end 2009-04-23 by bhsohn 에디트창 커서 이동
	m_pEditPartyName->BackupTxtString();	// 뺵업
...
int nPosX, nPosY;
	...
	{		
		...
		nPosX = ptBkPos.x + CURRENT_PARTY_OPTION_BTN_START_X + pPos.x;
		nPosY = ptBkPos.y + CURRENT_PARTY_OPTION_BTN_START_Y;
	...
	}
	{
		...
		{
			{ptBkPos.x+72, ptBkPos.y+276},
			{ptBkPos.x+72, ptBkPos.y+315},			
		};
	...
	{		
		...
		nPosX = ptBkPos.x + CURRENT_PARTY_BTN_START_X + pPos.x;
		nPosY = ptBkPos.y + CURRENT_PARTY_BTN_START_Y + COMMU_BK_START_Y;		
		m_pSCrateBtn->SetBtnPosition(nPosX, nPosY);	
	}
