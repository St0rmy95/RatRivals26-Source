...
#include "INFBaseWarManager.h"			// 2014-05-07 by ymjoo 인터페이스를 꺼도 거점전 시간이 흐르도록 수정
...
//	m_pGageBox = NULL;
	...
	// end 2008-02-27 by bhsohn 아레나 이동시 채팅정보 뺵업
...
// end 2011. 10. 10 by jskim UI시스템 변경														  
					...
					// 2014-05-12 by ymjoo 인터페이스를 꺼도 현재 시간이 갱신되도록 수정
					m_pGameMain->UpdateServerTimeString();
					// END 2014-05-12 by ymjoo 인터페이스를 꺼도 현재 시간이 갱신되도록 수정
				}
			}
				 ...
				 case WNDWorldMap :
					 {
						 ...
						 {
							return INF_MSGPROC_BREAK;				// 월드맵 처리
						 }
#endif
					 }
					 break;		   
...
#ifdef C_WORLD_MAP_SSJUNG_YMJOO
						if(g_pGameMain)
							g_pGameMain->RenderWorldMap();				// 월드맵 처리
#endif
					}
					break;		 
// end 2014-03-11 by ssjung&ymjoo 월드맵 구현
