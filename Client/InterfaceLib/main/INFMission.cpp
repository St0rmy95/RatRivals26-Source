...
CINFMission::~CINFMission()
{
	...
	{
		SAFE_DELETE(m_pOk[i]);
		SAFE_DELETE(m_pPrev[i]);
		SAFE_DELETE(m_pNext[i]);
	}
//	SAFE_DELETE(m_pFontQuestName);
...
*/	int i; for(i=0;i<MISSION_LINE_NUMBER;i++)
	{
