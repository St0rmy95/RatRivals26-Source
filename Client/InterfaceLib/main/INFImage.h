...
public:
	...
	D3DCOLOR GetColor() { return m_dwColor; }		// 2014-03-11 by ssjung&ymjoo 월드맵 구현
	...
	void SpriteBegin() { if(m_bSpriteCrate) m_pd3dxSprite->Begin(0); }
	...
	const PRECT GetPtRect ( void ) { return m_pRect; }
