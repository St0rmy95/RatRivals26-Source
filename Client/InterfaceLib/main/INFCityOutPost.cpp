...
// 2013-09-26 by ssjung 전진기지전 정보 창에서 여단마크, 여단장이름이 흐릿하게 보이는 문제 추가 수정
					...
					m_pFontExp->DrawText((int)(WARINFO_OUTPOST_FONT_GUILD_CENTER_X-(((sz.cx + fIsGuild)/2)+0.5f)) + fIsGuild,WARINFO_OUTPOST_FONT_DATA_1_GUILDNAME_Y + (i * WARINFO_OUTPOST_FONT_H),
						GUI_FONT_COLOR,buf);
					// 길드 마크.
					if(it->pGuildMark != NULL)
					{
						...
						it->pGuildMark->Move( (int)(WARINFO_OUTPOST_FONT_GUILD_CENTER_X-(((sz.cx + fIsGuild)/2)+0.5f)),WARINFO_OUTPOST_GUILDMARK_1_Y + (i * WARINFO_OUTPOST_FONT_H));
						it->pGuildMark->Render();
					}
// end 2013-09-26 by ssjung 전진기지전 정보 창에서 여단마크, 여단장이름이 흐릿하게 보이는 문제 추가 수정
