...
#define GUI_FONT_COLOR_SKY					RGB(2,137,255)			//기본색상 (하늘색)		 	`
#define GUI_FONT_COLOR_M					RGB(255,0,255)			//기본색상 (magenta)
...
//#define WEAR_ITEM_KIND_ATTACHMENT		6		// 2006-06-28 by ispark, 무제한 악세사리
#define WEAR_ITEM_KIND_ACCESSORY_UNLIMITED		6		// 2006-06-28 by ispark, 무제한 악세사리

#define WEAR_ITEM_KIND_ENGINE					7

// 2010-06-15 by shcho&hslee 펫시스템
//#define WEAR_ITEM_KIND_PET						8
#define WEAR_ITEM_KIND_ACCESSORY_TIME_LIMIT		8		// 2006-06-28 by ispark, 시간제한 악세사리

#define WEAR_ITEM_KIND_WINGIN					9		// 2006-06-28 by ispark, 시간제한 악세사리

// 2010-06-15 by shcho&hslee 펫시스템
//#define WEAR_ITEM_KIND_PARTNER					10		// 2010-06-08 by dgwoo, 펫시스템 추가. 
#define WEAR_ITEM_KIND_PET						10


// 장착 아이템 이펙트 번호 규칙
#define EFFECT_WEAR_WEAPON_1			100000		// 아이템 번호에서 이값을 더하면 이펙트 번호가 된다.
#define EFFECT_WEAR_WEPAON_11_DEFAULT	12100000
#define EFFECT_WEAR_WEPAON_12_DEFAULT	12200000
#define EFFECT_WEAR_WEAPON_2			700000		// 아이템 번호에서 이값을 빼면 이펙트 번호가 된다.
...
typedef enum 
{
	...
	WNDFirstAnniversaryEvent,		//1주년 이벤트	// 2013-10-01 by ssjung 1주년 이벤트
	WNDWorldMap,					// 2014-03-11 by ssjung&ymjoo 월드맵 구현
	WNDIndexEnd				// 행열의 마지막
}WNDWINDOWSINDEX;
