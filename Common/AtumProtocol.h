...
#define T0_FC_CHARACTER				0x22	//0x32		    // 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
#define T0_FC_CHAT					0x26	//0x33			// 2015-07-03 by bckim, 게임포지 블럭해킹 조치사항 2탄
...
#define T0_FC_ITEM					0x23	//0x39	    // 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
...
#define T0_FC_STORE					0x24	//0x42	    // 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
#define T0_FC_STRING				0x43
#define T0_FC_TIMER					0x44
#define T0_FC_TRADE					0x25	//0x45		// 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
...
// FC, Field Server <-> Client 2차			(0xD1 ~ 0xDF 예약)	// 2011-10-18 by hskim, EP4 [트리거 시스템] - 화산재 / 모래 폭풍
#define T0_FC_TRIGGER				0xD1						// 2011-10-18 by hskim, EP4 [트리거 시스템] - 화산재 / 모래 폭풍
#define	T0_FC_COLLECTION			0xD5	// 0xD2	// 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항 // 2013-05-31 by jhseol,bckim 아머 컬렉션 - 패킷 추가 : 해더
#define	T0_FC_MARKET				0xD6	// 0xD3 // 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항 // 2013-11-25 by jhseol&bckim, 거래소 - 패킷 추가 : 해더


// 2015-07-03 by bckim, 게임포지 블럭해킹 조치사항 2탄
// FI, Field Server <-> IM Server
#define T0_FI_ADMIN				0x60	//	0x50
#define T0_FI_CHARACTER			0x61	//	0x5A	//	0x51		// 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
#define T0_FI_CHAT				0x6A	//	0x5B	//	0x52		// 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
#define T0_FI_EVENT				0x6B	//	0x5C	//	0x53		// 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
#define T0_FI_GUILD				0x64	//	0x54
#define T0_FI_PARTY				0x65	//	0x55
#define T0_FI_CITYWAR			0x66	//	0x56
#define T0_FI_CASH				0x67	//	0x57
#define T0_FI_INFO				0x68	//	0x58			// 2009-01-12 by dhjin, 선전 포고

// FN, Field Server <-> NPC Server
#define T0_FN_BATTLE			0x50	//	0x60
#define T0_FN_CHARACTER			0x5A	//	0x61
#define T0_FN_EVENT				0x5B	//	0x6A	//	0x62		// 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
#define T0_FN_MONSTER			0x5C	//	0x6B	//	0x63		// 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항
...
#define T0_IC_CHATROOM				0x9A	//0x88			// 2008-06-16 by dhjin, EP3 채팅방 -
#define T0_IC_INFO					0x9B	//0x89			// 2009-01-12 by dhjin, 선전 포고
// End. 2015-07-03 by bckim, 게임포지 블럭해킹 조치사항 2탄
...
//									0xD1 ~ 0xDF		// FC, Field Server <-> Client 2차 예약		// start 2011-10-18 by hskim, EP4 [트리거 시스템] - 화산재 / 모래 폭풍
...
#define T1_FC_CONNECT_BUGTRAPSERVER_INFO		0x12	// 2014-01-27 by bckim, 버그 트랩
...
#define T1_IP_SELECTIVE_SHUTDOWN_NOTICE				0x0B	// P->I // 2012-07-11 by hskim, 선택적 셧다운
#define T1_IP_MONITOR_RELOAD_VERSION_INFO_OK		0x0C	// P->I // 2013-03-14 by jhseol, 버전인포 리로드 시 접속 허용 IP리스트도 갱신
#define T1_IP_RELOAD_GUILD_INFO						0x0D	// 2014-02-11 by bckim, 세력초기화시 정보 동기화처리
...
#define T1_FC_CHARACTER_GET_USER_ITEM_INFO					0x94	// 2012-06-05 by jhseol, 아템미리보기 - 살펴볼 케릭터 UID
#define T1_FC_CHARACTER_GET_USER_ITEM_INFO_OK				0x95	// 2012-06-05 by jhseol, 아템미리보기 - 살펴본 케릭터의 아템정보
#define T1_FC_CHARACTER_GET_USER_ITEM_INFO_OK_DONE			0x96	// 2012-06-05 by jhseol, 아템미리보기 - 살펴본 케릭터의 아템정보
#define T1_FC_CHARACTER_GET_USER_ITEM_INFO_SECRET			0x97	// 2012-07-12 by isshin 아템미리보기 On / Off 기능 - 공개 여부
#define T1_FC_CHARACTER_GET_USER_ITEM_INFO_SECRET_OK		0x98	// 2012-07-12 by isshin 아템미리보기 On / Off 기능 - 공개 여부

// 2012-10-10 by jhjang 해피 아워 경험치 보너스 시스템 리뉴얼
#define T1_FC_CHARACTER_KILLCOUNT							0x99	// 2012-10-10 by jhjang 킬카운트 시스템 추가
#define T1_FC_CHARACTER_RESTCOUNT							0x9A	// 2012-10-10 by jhjang 휴식 경험치 시스템 추가
#define T1_FC_CHARACTER_BONUS_EXP_RATE						0x9B	// 2012-10-10 by jhjang 보너스 경험치 표시 추가
// end 2012-10-10 by jhjang 해피 아워 경험치 보너스 시스템 리뉴얼

//////////////////////////////////////////////////////////////////////
// 2012-10-05 by jhseol, NPlay PC방 모듈 - 객체 생성 및 NPlay 서버 Connect
#define T1_FC_CHARACTER_PCBANG_PREMIUN_APPLY				0x9C	// pc방 프리미엄 적용 여부
...
#define T1_FC_CHARACTER_PAY_CONTRIBUTIONPOINT				0xA0	// 2013-08-14 by jhseol, 거점전 리뉴얼 - 세력포인트 비율 변경
#define T1_FC_BUGTRAP_ACCEPT								0xA1	// 2014-01-27 by bckim, 버그 트랩	
...
#define T1_FC_MOVE_NPROTECT_NEW_REQ_AUTH_DATA		0xBA	// 2015-01-07 by jwLee 게임포지 nProtector S->C
#define T1_FC_MOVE_NPROTECT_NEW_REQ_AUTH_DATA_OK	0xBB	// 2015-01-07 by jwLee 게임포지 nProtector C->S
...
#define T1_FC_PARTY_AUTO_CREATED_THE_ARENA				0x31	// 2012-04-12 by jhseol, 아레나 추가개발 - 자동파티 : 자동으로 파티를 만들라는 패킷.
#define T1_FC_PARTY_REQUEST_INVITE_QUESTION_THE_ARENA	0x32	// 2012-04-12 by jhseol, 아레나 추가개발 - 자동파티 : 파티에 가입시킬 클라에게 파티 가입 준비 패킷 보내기.
...
#define T1_FI_PARTY_ARENA_TEAM_NUM						0x34	// F->I, // 2012-04-12 by jhseol, 아레나 추가개발 - 자동파티 : 팀번호 보내기
...
#define T1_FN_MONITOR_RELOAD_VERSION_INFO_OK			0x17	// 2013-03-14 by jhseol, 버전인포 리로드 시 접속 허용 IP리스트도 갱신
...
//#define T1_FP_ADMIN_STRATRGYPOINT_INFO_CHANGE	0x04	// 2012-11-13 by jhseol, 전쟁 시스템 리뉴얼 - 거점전, 어드민에서 거점셋팅을 변경했다고 알림

// #define T0_FP_ADMIN					0x73			// 2008-01-31 by cmkwon, 계정 블럭/해제 명령어로 가능한 시스템 구현 - 
#define T1_FP_ADMIN_BLOCKACCOUNT				0x20	// 2008-01-31 by cmkwon, 계정 블럭/해제 명령어로 가능한 시스템 구현 - 
#define T1_FP_ADMIN_BLOCKACCOUNT_OK				0x21	// 2008-01-31 by cmkwon, 계정 블럭/해제 명령어로 가능한 시스템 구현 - 
#define T1_FP_ADMIN_UNBLOCKACCOUNT				0x22	// 2008-01-31 by cmkwon, 계정 블럭/해제 명령어로 가능한 시스템 구현 - 
#define T1_FP_ADMIN_UNBLOCKACCOUNT_OK			0x23	// 2008-01-31 by cmkwon, 계정 블럭/해제 명령어로 가능한 시스템 구현 - 
#define T1_FP_ADMIN_STRATRGYPOINT_INFO_CHANGE	0x24	// 2012-11-13 by jhseol, 전쟁 시스템 리뉴얼 - 거점전, 어드민에서 거점셋팅을 변경했다고 알림
// End 2015-06-10 by bckim, 게임포지 블럭해킹 조치사항


// start 2011-12-12 by hskim, GLog 2차
#define T1_FP_GLOG_CONNECT_USER_NEW				0x00	// P->F, GLog 계정 생성 이벤트
#define T1_FP_GLOG_CONNECT_USER_LOGIN			0x01	// P->F, GLog 계정 로그인 이벤트
// end 2011-12-12 by hskim, GLog 2차

#define T1_FP_GLOG_NEW_ACCOUNT_INFO				0x02	// P->F, GLog 계정 생성			// 2013-03-14 by bckim, Glog 기능추가
...
#define T1_FC_STORE_UPDATE_ARMOR_ITEM_EVENT_INFO	0x19	// 2013-04-18 by jhseol,bckim 이달의 아머 - 이달의 아머 변경 사항 전달 패킷
...
#define T1_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE		0x6e	// C->F, 세력변경 카드
#define T1_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE_NOTIFY	0x70	// F->C, 세력변경 카드
...
#define T1_FC_SHOP_CLOSE					0x1A	// 2011-10-28 by hskim, EP4 [트리거 시스템] - 크리스탈 시스템
#define T1_FC_SHOP_BUY_ITEM_UPDATE			0x1B	// F->C, // 2011-12-26 by hskim, EP4 [트리거 시스템] - 크리스탈 시스템
#define T1_FC_SHOP_AUTH_KEY					0x1C	// C->F, 웹 캐시 상점용 인증키 전달 - // 2013-03-13 by hskim, 웹 캐시 상점
#define T1_FC_SHOP_INFLUENCE_BUFF			0x1D	// C->F, // 2013-05-09 by hskim, 세력 포인트 개선
#define T1_FC_SHOP_INFLUENCE_BUFF_OK		0x1E	// F->C, // 2013-05-09 by hskim, 세력 포인트 개선
...
#define T1_FC_OBJECT_CHANGE						0x02	// C -> F(n), 2011-11-07 by hskim, EP4 [트리거 시스템] - 크리스탈 시스템
...
#define T1_FI_GUILD_BONUS_EXP_RATE				0x14	// 2012-10-12 by jhjang 여단 경험치 보너스 비율 전송
// 2012-10-12 by jhjang 해피 아워 경험치 보너스 시스템 리뉴얼
// IC_GUILD
...
#define T1_FC_INFO_NGCSPWAR_DISPLAY						0x73	// 2013-08-14 by jhseol, 거점전 리뉴얼 - NGC 거점
...
#define T1_FC_WAR_INFLUENCE_CONSECUTIVE_VICTORITES	0x34	// 2013-05-09 by hskim, 세력 포인트 개선
#define T1_FC_WAR_INFLUENCE_CONSECUTIVE_POINT		0x35	// F->C // 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - 세력포인트 정보 보내주기
#define T1_FC_INFLUENCE_SHOW_INFO					0x36	// F->C // 2014-06-17 by bckim, 세력 불균형 ( 세력정보 및 우세세력 표시 )
...
#define T1_FC_ARENA_PLAY_CHARACTER_TYPE			0x28	// c->f(a)	// 2012-06-08 by jhseol, 아레나 추가개발part2 - 케릭터 : 타입 복사
...
/////////////////////////////////////////////////////////////////////////////////////////////
// T0_FC_COLLECTION
#define T1_FC_COLLECTION_INFO							0x00		// 2013-05-31 by jhseol,bckim 아머 컬렉션 - 패킷 추가 : 컬렉션 정보 패킷
#define T1_FC_COLLECTION_SHAPE_CHANGE					0x01		// 2013-05-31 by jhseol,bckim 아머 컬렉션 - 패킷 추가 : 외형 변경 요청 패킷
#define T1_FC_COLLECTION_MONTHLY_AROMOR_EVENT_INIT		0x02		// 2013-04-18 by jhseol,bckim 이달의 아머 - 패킷 추가 : 컬렉션에 표시할 이달의아머 이벤트 정보 초기화 패킷
#define T1_FC_COLLECTION_MONTHLY_AROMOR_EVENT_INFO		0x03		// 2013-04-18 by jhseol,bckim 이달의 아머 - 패킷 추가 : 컬렉션에 표시할 이달의아머 이벤트 정보 패킷
...
#define T1_FtoA_ARENA_CHARACTERARENAINFO_UPDATA	0x0C	// 2012-04-12 by jhseol, 아레나 추가개발 - 보상 : AFS -> MFS CharacterArena UUpdata 요청 패킷
#define T1_FtoA_ARENA_CHARACTER_RESET_RELOAD	0x0D	// 2012-12-18 by jhseol, 아레나 캐릭터 리셋 후 캐릭터 정보 다시 로딩하기.
...
#define T1_FtoA_INFINITY_COME_BACK_PREWORK		0x46	//  AMF - >MFS // 2011-09-29 by hskim, 파트너 시스템 2차 - 인피 MainFieldServer로 돌아가기 위한 사전 작업 처리 명령
...
#define T1_FtoA_INFINITY_COME_BACK_POSTWORK		0x48	//  AMF - >MFS // 2011-09-29 by hskim, 파트너 시스템 2차 - 인피 MainFieldServer로 돌아가기 위한 후 작업 처리 명령
...
#define T_FC_CONNECT_BUGTRAPSERVER_INFO			(MessageType_t)((T0_FC_CONNECT<<8)|T1_FC_CONNECT_BUGTRAPSERVER_INFO)				// 2014-01-27 by bckim, 버그 트랩
...
#define T_IP_MONITOR_RELOAD_VERSION_INFO_OK		(MessageType_t)((T0_IP_CONNECT<<8)|T1_IP_MONITOR_RELOAD_VERSION_INFO_OK)	// P->I // 2013-03-14 by jhseol, 버전인포 리로드 시 접속 허용 IP리스트도 갱신
...
#define T_FC_CHARACTER_GET_USER_ITEM_INFO_SECRET			(MessageType_t)((T0_FC_CHARACTER<<8)|T1_FC_CHARACTER_GET_USER_ITEM_INFO_SECRET)				// C->F	// 2012-07-12 by isshin 아템미리보기 On / Off 기능 - 공개 여부
#define T_FC_CHARACTER_GET_USER_ITEM_INFO_SECRET_OK			(MessageType_t)((T0_FC_CHARACTER<<8)|T1_FC_CHARACTER_GET_USER_ITEM_INFO_SECRET_OK)			// F->C	// 2012-07-12 by isshin 아템미리보기 On / Off 기능 - 공개 여부
...
#define T_FC_BUGTRAP_ACCEPT									(MessageType_t)((T0_FC_CHARACTER<<8)|T1_FC_BUGTRAP_ACCEPT)		// 2014-01-27 by bckim, 버그 트랩

#define T_FC_CHARACTER_PAY_CONTRIBUTIONPOINT		(MessageType_t)((T0_FC_CHARACTER<<8)|T1_FC_CHARACTER_PAY_CONTRIBUTIONPOINT)		// F->C, // 2013-08-14 by jhseol, 거점전 리뉴얼 - 세력포인트 비율 변경
...
#define T_FC_MOVE_NPROTECT_NEW_REQ_AUTH_DATA	(MessageType_t)((T0_FC_MOVE<<8)|T1_FC_MOVE_NPROTECT_NEW_REQ_AUTH_DATA)		// 2015-01-07 by jwLee 게임포지 nProtector 적용 S->C
#define T_FC_MOVE_NPROTECT_NEW_REQ_AUTH_DATA_OK	(MessageType_t)((T0_FC_MOVE<<8)|T1_FC_MOVE_NPROTECT_NEW_REQ_AUTH_DATA_OK)	// 2015-01-07 by jwLee 게임포지 nProtector 적용 C->S
...
#define T_FC_PARTY_AUTO_CREATED_THE_ARENA			(MessageType_t)((T0_FC_PARTY<<8)|T1_FC_PARTY_AUTO_CREATED_THE_ARENA)				// 2012-04-12 by jhseol, 아레나 추가개발 - 자동파티 : 자동으로 파티를 만들라는 패킷.
#define T_FC_PARTY_REQUEST_INVITE_QUESTION_THE_ARENA	(MessageType_t)((T0_FC_PARTY<<8)|T1_FC_PARTY_REQUEST_INVITE_QUESTION_THE_ARENA)	// 2012-04-12 by jhseol, 아레나 추가개발 - 자동파티 : 파티에 가입시킬 클라에게 파티 가입 준비 패킷 보내기.
...
#define T_FI_PARTY_ARENA_TEAM_NUM					(MessageType_t)((T0_FI_PARTY<<8)|T1_FI_PARTY_ARENA_TEAM_NUM)	// 2012-04-12 by jhseol, 아레나 추가개발 - 자동파티 : 팀번호 보내기
...
#define T_FN_MONITOR_RELOAD_VERSION_INFO_OK			(MessageType_t)((T0_FN_NPCSERVER<<8)|T1_FN_MONITOR_RELOAD_VERSION_INFO_OK)		// 2013-03-14 by jhseol, 버전인포 리로드 시 접속 허용 IP리스트도 갱신
...
#define T_FP_ADMIN_STRATRGYPOINT_INFO_CHANGE	(MessageType_t)((T0_FP_ADMIN<<8)|T1_FP_ADMIN_STRATRGYPOINT_INFO_CHANGE)	// 2012-11-13 by jhseol, 전쟁 시스템 리뉴얼 - 거점전
...
#define T_FC_STORE_UPDATE_ARMOR_ITEM_EVENT_INFO	(MessageType_t)((T0_FC_STORE<<8)|T1_FC_STORE_UPDATE_ARMOR_ITEM_EVENT_INFO)		// 2013-04-18 by jhseol,bckim 이달의 아머 - 이달의 아머 변경 사항 전달 패킷
...
// 2014-06-10 by bckim, 세력변경 아이템
#define T_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE			(MessageType_t)((T0_FC_ITEM<<8)|T1_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE)			// 세력변경 카드
#define T_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE_NOTIFY	(MessageType_t)((T0_FC_ITEM<<8)|T1_FC_ITEM_USE_CARDITEM_CHANGE_INFLUENCE_NOTIFY)	// 세력변경 카드
// End. 2014-06-10 by bckim, 세력변경 아이템
...
#define T_FC_SHOP_BUY_ITEM_UPDATE				(MessageType_t)((T0_FC_SHOP<<8)|T1_FC_SHOP_BUY_ITEM_UPDATE)						// F->C, // 2011-12-26 by hskim, EP4 [트리거 시스템] - 크리스탈 시스템
...
#define T_FC_SHOP_CLOSE							(MessageType_t)((T0_FC_SHOP<<8)|T1_FC_SHOP_CLOSE)					// F->C, // 2011-10-28 by hskim, EP4 [트리거 시스템] - 크리스탈 시스템
#define T_FC_SHOP_INFLUENCE_BUFF				(MessageType_t)((T0_FC_SHOP<<8)|T1_FC_SHOP_INFLUENCE_BUFF)			// C->F, // 2013-05-09 by hskim, 세력 포인트 개선
#define T_FC_SHOP_INFLUENCE_BUFF_OK				(MessageType_t)((T0_FC_SHOP<<8)|T1_FC_SHOP_INFLUENCE_BUFF_OK)		// F->C, // 2013-05-09 by hskim, 세력 포인트 개선
...
#define T_FC_OBJECT_CHANGE						(MessageType_t)((T0_FC_OBJECT<<8)|T1_FC_OBJECT_CHANGE)					// F -> C(n), 2011-11-07 by hskim, EP4 [트리거 시스템] - 크리스탈 시스템
...
#define T_FC_WAR_INFLUENCE_CONSECUTIVE_VICTORITES		(MessageType_t)((T0_FC_WAR<<8)|T1_FC_WAR_INFLUENCE_CONSECUTIVE_VICTORITES)		// 2013-05-09 by hskim, 세력 포인트 개선
#define T_FC_WAR_INFLUENCE_CONSECUTIVE_POINT			(MessageType_t)((T0_FC_WAR<<8)|T1_FC_WAR_INFLUENCE_CONSECUTIVE_POINT)	// F->C // 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - 세력포인트 정보 보내주기
#define T_FC_INFLUENCE_SHOW_INFO						(MessageType_t)((T0_FC_WAR<<8)|T1_FC_INFLUENCE_SHOW_INFO)	// F->C // 2014-06-17 by bckim, 세력 불균형 ( 세력정보 및 우세세력 표시 )
...
typedef struct
{
	...
	BOOL	ConnectToTestServer;	// 2014-01-06 by jhseol, 테섭 접속 여부(TRUE=테섭, FALSE=본섭)
...
{
	ATUM_DATE_TIME	RegisteredDate;					// 생성일자
	INT			Type;								// 생성타입
	UID64_t		AccountUniqueNumber;				// 계정고유번호 
...
struct MSG_FC_MOVE_NPROTECT_NEW_REQ_AUTH_DATA		// 2015-01-07 by jwLee 게임포지 nProtector 적용
{
	BYTE 	reqAuthData[MAX_PACKET_SIZE_FOR_NPROTECT_NEW];
	UINT32	datasize;
};
struct MSG_FC_MOVE_NPROTECT_NEW_REQ_AUTH_DATA_OK	// 2015-01-07 by jwLee 게임포지 nProtector 적용
{
...
typedef MSG_FC_PARTY_REQUEST_INVITE_QUESTION	MSG_FC_PARTY_REQUEST_INVITE_QUESTION_THE_ARENA;	// 2012-04-12 by jhseol, 아레나 추가개발 - 자동파티 : 파티에 가입시킬 클라에게 파티 가입 준비 패킷 보내기.
...
struct MSG_FN_MONSTER_STRATEGYPOINT_INIT		// 2006-11-20 by cmkwon
{
	...
	INT					SummonMonsterNum;		// 2013-08-14 by jhseol, 거점전 리뉴얼 - 모선전시 소환할 몬스터번호
};

struct MSG_FN_MONSTER_STRATEGYPOINT_SUMMON
{
	MapIndex_t			MapIndex;
	INT					SummonMonsterNum;		// 2013-08-14 by jhseol, 거점전 리뉴얼 - 일반전시 소환할 몬스터번호
};
...
} MSG_FC_ITEM_NOTIFY_WINDOW_POSITION;		// F -> C, 아이템의 ItemWindowIndex 변경될시에 클라이언트에게 알려준다
...
struct SHOP_ITEM
{
	...
	INT			RecommandedIdx;						// 2013-09-24 by bckim, 캐시샵 추천탭 정렬순서부여 보완
...
typedef MSG_FC_STORE_INSERT_ITEM		MSG_FC_ENEMY_ITEM_INFO;		// 2012-06-05 by jhseol, 아템미리보기 - 클라요청 패킷 추가
...
struct MSG_FC_INFO_GET_HAPPY_HOUR_EVENT_INFO_OK
{
	...
	// End. 2013-08-12 by bckim, 신규해피아워
};
...
#define STR128_PRINT_TYPE_OPERATOR	(BYTE)0x05	// 2013-10-02 by bckim, 보스몬스터 보상강화 스트링 보완작업 
...
#define T1_FL_LOG_DELETE_CHARACTER_BY_ADMIN		0x58	// 88 - 툴에서 캐릭터 삭제 - 2014-01-21 by jekim, 툴에서 캐릭터 삭제 가능하게 하기.

// 2014-01-03 by jhseol&bckim, 파괴경매장 - GameLog 추가
#define T1_FL_LOG_DESTROY_AUCTION_TENDER		0x59	// 89 - 입찰
#define T1_FL_LOG_DESTROY_AUCTION_FIX			0x5A	// 90 - 낙찰
#define T1_FL_LOG_DESTROY_AUCTION_GET			0x5B	// 91 - 낙찰품 회수
...
#define	T1_FL_GLOG_NEW_ACCOUNT_INFO						0xD2	// 210 - // 2013-03-14 by bckim, Glog 기능추가
...
#define T_FL_LOG_ALL_MONSTER_KILL_LOG			(MessageType_t)((T0_FL_LOG<<8)|T1_FL_LOG_ALL_MONSTER_KILL_LOG)		// 2014-03-31 by bckim, 모든 몬스터 킬로그 ( 캐나다 요청)
...
#define T_FL_GLOG_NEW_ACCOUNT_INFO				(MessageType_t)((T0_FL_LOG<<8)|T1_FL_GLOG_NEW_ACCOUNT_INFO)			// 210		// 2013-03-14 by bckim, Glog 기능추가
...
#define T_FL_LOG_BUGTRAP_ACCEPT					(MessageType_t)((T0_FL_LOG<<8)|T1_FL_LOG_BUGTRAP_ACCEPT)			// 229		// 2014-01-27 by bckim, 버그 트랩

#define T_FL_LOG_USE_SKILL						(MessageType_t)((T0_FL_LOG<<8)|T1_FL_LOG_USE_SKILL)						// 230		// 2014-03-31 by jekim, 스킬 사용 로그

#define T_FL_LOG_MONITOR_RELOAD_VERSION_INFO_OK	(MessageType_t)((T0_FL_LOG<<8)|T1_FL_LOG_MONITOR_RELOAD_VERSION_INFO_OK)	// 254 - // 2013-03-14 by jhseol, 버전인포 리로드 시 접속 허용 IP리스트도 갱신
...
struct MSG_FL_LOG_ITEM_BUY_ITEM: public FL_ITEM_LOG_BASE
{
	...
	INT				IsCashItem;		// 2015-02-24 by shchoi WP와 구분짓기 위해 BOOL형에서 INT형으로 변환 // 2006-06-21 by cmkwon, 유료 아이템
...
#define T1_PA_ADMIN_RELOAD_GUILD_INFO			0x19		// A->P	// 2014-02-11 by bckim, 세력초기화시 정보 동기화처리
...
#define T_PA_ADMIN_RELOAD_GUILD_INFO			(MessageType_t)((T0_PA_ADMIN<<8)|T1_PA_ADMIN_RELOAD_GUILD_INFO)			// A->P, // 2014-02-11 by bckim, 세력초기화시 정보 동기화처리
...
{// 2008-06-17 by dhjin, EP3 채팅방 - 채팅방 초대 승락 유저 정보 전송
	UID32_t	CharacterUID;
	char	CharacterName[SIZE_MAX_CHARACTER_NAME];
	BYTE	CharacterLevel;		// 2014-01-27 by jhseol, 채팅방 lv 정보 추가
};
...
{// 2008-03-26 by dhjin, 모선전 정보 표시 기획안 - 유저에게 필요한 정보 표시 데이타
	...
	BYTE			DisplatType;	// 2013-08-14 by jhseol, 거점전 리뉴얼 - 출력 타입 (0:모선전, 1:일반 거점전)
};
...
#define T_IP_RELOAD_GUILD_INFO			(MessageType_t)((T0_IP_CONNECT<<8)|T1_IP_RELOAD_GUILD_INFO)		// 2014-02-11 by bckim, 세력초기화시 정보 동기화처리
...
// 2014-02-11 by bckim, 세력초기화시 정보 동기화처리
...
////////////////////////////////////////////////////////////////////////////
// 2012-10-05 by jhseol, NPlay pc방 모듈
#define T_FP_PCBANG_USER_GAME_START				(MessageType_t)((T0_FP_CONNECT<<8)|T1_FP_PCBANG_USER_GAME_START)			// 게임시작 알림
#define T_FP_PCBANG_USER_GAME_END				(MessageType_t)((T0_FP_CONNECT<<8)|T1_FP_PCBANG_USER_GAME_END)				// 게임종료 알림
#define T_FP_PCBANG_USER_PREMIUN_END			(MessageType_t)((T0_FP_CONNECT<<8)|T1_FP_PCBANG_USER_PREMIUN_END)			// PC방 프리미엄 과금 종료
#define T_FP_PCBANG_USER_PREMIUM_INFO			(MessageType_t)((T0_FP_CONNECT<<8)|T1_FP_PCBANG_USER_PREMIUM_INFO)			// pc방 프리미엄 정보
#define T_FP_PCBANG_USER_PREMIUM_REQUEST		(MessageType_t)((T0_FP_CONNECT<<8)|T1_FP_PCBANG_USER_PREMIUM_REQUEST)		// pc방 프리미엄 정보요청
#define T_FP_PCBANG_USER_PREMIUM_RESIDUAL_TIME	(MessageType_t)((T0_FP_CONNECT<<8)|T1_FP_PCBANG_USER_PREMIUM_RESIDUAL_TIME)	// pc방 프리미엄 잔여시간

typedef struct
{
	char				AccountName[SIZE_MAX_ACCOUNT_NAME];			// 사용자 아이디
	char				ServerGroupName[SIZE_MAX_SERVER_NAME];		// 서버 그룹 이름
	BOOL				PremiumApply;								// 프리미엄 해택 적용 여부
...
{
	char				AccountName[SIZE_MAX_ACCOUNT_NAME];			// 사용자 아이디
	DWORD				ResidualTime;								// 프리미엄 해택 적용 여부
...
#define GLOG_IL_LT_WARPOINT_ADD					0x45 // 2014-03-20 by jekim, GLog 워포통계
#define GLOG_IL_LT_WARPOINT_DEL					0x46 // 2014-03-20 by jekim, GLog 워포통계
...
// MSG 선언부분
typedef COLLECTION_INFO							MSG_FC_COLLECTION_INFO;				// 컬렉션 정보 패킷
typedef COLLECTION_SHAPE_CHANGE					MSG_FC_COLLECTION_SHAPE_CHANGE;		// 외형 변경 요청 패킷
...
#define GAMELOG_COLLECTION_STATE_MONTHLY_EVENT	5	// 2013-09-06 by jhseol, 이달의 아머 이벤트 적용 기간 변경 - 이달의 아머 이벤트정보 변경	
struct MSG_FL_LOG_COLLECTION_STATE
{
	...
	char *GetWriteLogString(int i_nLogType, char *o_szLogString)
	{
		sprintf(o_szLogString, "%s|%d|%d|%d|%d|%d(%d)|%d|%d(%s)|%d(%s)\r\n", GetGameLogTypeString(i_nLogType), CollectionInfo.CollectionType, CollectionState, CollectionInfo.AccountUID, CollectionInfo.CharacterUID
			...
			, CollectionInfo.nOptionItemNum, CollectionInfo.DurationTime.GetDateTimeString(STRNBUF(SIZE_MAX_SQL_DATETIME_STRING)));	// 2013-09-06 by jhseol, 이달의 아머 이벤트 적용 기간 변경
		return o_szLogString;
	}
};
...
#define T_FC_INFO_NGCSPWAR_DISPLAY	(MessageType_t)((T0_FC_INFO<<8)|T1_FC_INFO_NGCSPWAR_DISPLAY)			// 2013-08-14 by jhseol, 거점전 리뉴얼 - NGC 거점
enum NGCSP_STATE
{
	NGCSP_START = 0,
	NGCSP_PLAYING,
...
{// 2008-03-26 by dhjin, 모선전 정보 표시 기획안 - 유저에게 필요한 정보 표시 데이타
	MapIndex_t		MapIndex;
	INT				HPRate;					// 거점 HP비율 백분률
	BYTE			BCUContributePercent;	// BCU세력의 기여도 100-BCUContributePercent 하면 ANI세력의 기여도
	BYTE			State;					// NGC거점전 상태
	ATUM_DATE_TIME	StartTime;				// 거점 생성시간, 해당 시간 기준 1시간동안 거점전 진행
};
