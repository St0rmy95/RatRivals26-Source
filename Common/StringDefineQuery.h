...
#define QUERY_080702_0010_2		" l.accountname, l.Time, i.LogStringKO, l.IPAddress, l.ServerName"
...
#define QUERY_131120_0001 "CAST(l.CurrentCount AS VARCHAR(10)) + 'counts materials:' + l.Param1 " // 2013-11-20 by jekim, 조합, 융해 툴에서 볼 수 있게 수정.
...
#define QUERY_131224_0001_A	" and l.AccountUniqueNumber = \'%s\' "
#define QUERY_131224_0001_B	" and c.AccountUniqueNumber = \'%s\' "
#define QUERY_131224_0001_C	" and (c.AccountUniqueNumber = \'%s\' or c.accountname = \'%s\') "
#define QUERY_131224_0001_D	" and (c.AccountUniqueNumber = \'%s\' or c.AccountUniqueNumber = \'%s\') "
#define QUERY_131224_0002_A	" and l.CharacterUniqueNumber = \'%s\' "
#define QUERY_131224_0002_B	" and c.UniqueNumber = \'%s\' "
#define QUERY_131224_0003_1		" and l.AccountUID = \'%s\' "
#define QUERY_131224_0003_2		" and l.CharacterUID = \'%s\' "
