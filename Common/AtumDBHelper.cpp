...
#include "Global.h"				// 2009-04-15 by cmkwon, 시스템 로그 수정 - 
...
int CAtumDBHelper::LoadItemInfo(CODBCStatement *i_pODBCStmt, ez_map<INT, ITEM> *o_pMapItemInfo
								, CLocalization *i_pLocalization
								, ez_map<string, ITEM> *o_pMapItemInfoName /* = NULL */)
{
	// clear map
...
//	BOOL bRet = i_pODBCStmt->ExecuteQuery(QUERY_080702_0056);
	...
	// Bind Columns
	CAtumDBHelper::BindColITEM(i_pODBCStmt->m_hstmt, itemInfo, cb);

	int nObjects = 0;
	memset(&itemInfo, 0x00, sizeof(ITEM));
	while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA)
	{
		// 2005-05-24 by cmkwon, 현지화
		i_pLocalization->ItemLocalization(itemInfo.ItemNum, itemInfo.ItemName, itemInfo.Description);

		o_pMapItemInfo->insertEZ(itemInfo.ItemNum, itemInfo);
		if (o_pMapItemInfoName != NULL)
		{
// 2008-06-03 by cmkwon, AdminTool, DBTool 사용시 아이템 검색시 콤보박스에서 검색 기능 추가(K0000143) - 아래와 같이 수정 함
// 			int nLen = strlen(itemInfo.ItemName);
// 			if(SIZE_MAX_ITEM_NAME-10 >= nLen)
// 			{
// 				wsprintf(&(itemInfo.ItemName[nLen]), " %d", itemInfo.ItemNum);
// 			}
// 			else
// 			{
// 				wsprintf(&(itemInfo.ItemName[SIZE_MAX_ITEM_NAME-10]), " %8d", itemInfo.ItemNum);
// 			}
			///////////////////////////////////////////////////////////////////////////////
...
//	BOOL bRet = i_pODBCStmt->ExecuteQuery(QUERY_080702_0057);
	...
	SQLBindCol(i_pODBCStmt->m_hstmt,  4, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[0], 0, &arrCB[4]);
	SQLBindCol(i_pODBCStmt->m_hstmt,  5, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[1], 0, &arrCB[5]);
	SQLBindCol(i_pODBCStmt->m_hstmt,  6, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[2], 0, &arrCB[6]);
	SQLBindCol(i_pODBCStmt->m_hstmt,  7, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[3], 0, &arrCB[7]);
	SQLBindCol(i_pODBCStmt->m_hstmt,  8, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[4], 0, &arrCB[8]);
	SQLBindCol(i_pODBCStmt->m_hstmt,  9, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[5], 0, &arrCB[9]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 10, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[6], 0, &arrCB[10]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 11, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[7], 0, &arrCB[11]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 12, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[8], 0, &arrCB[12]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 13, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[9], 0, &arrCB[13]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 14, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[10], 0, &arrCB[14]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 15, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[11], 0, &arrCB[15]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 16, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[12], 0, &arrCB[16]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 17, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[13], 0, &arrCB[17]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 18, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[14], 0, &arrCB[18]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 19, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[15], 0, &arrCB[19]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 20, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[16], 0, &arrCB[20]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 21, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[17], 0, &arrCB[21]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 22, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[18], 0, &arrCB[22]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 23, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[19], 0, &arrCB[23]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 24, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[20], 0, &arrCB[24]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 25, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[21], 0, &arrCB[25]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 26, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[22], 0, &arrCB[26]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 27, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[23], 0, &arrCB[27]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 28, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[24], 0, &arrCB[28]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 29, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[25], 0, &arrCB[29]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 30, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[26], 0, &arrCB[30]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 31, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[27], 0, &arrCB[31]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 32, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[28], 0, &arrCB[32]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 33, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[29], 0, &arrCB[33]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 34, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[30], 0, &arrCB[34]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 35, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[31], 0, &arrCB[35]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 36, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[32], 0, &arrCB[36]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 37, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[33], 0, &arrCB[37]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 38, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[34], 0, &arrCB[38]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 39, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[35], 0, &arrCB[39]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 40, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[36], 0, &arrCB[40]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 41, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[37], 0, &arrCB[41]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 42, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[38], 0, &arrCB[42]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 43, SQL_C_PROB10K, &retEnchantInfo.ProbabilityPerLevel[39], 0, &arrCB[43]);
...
// 2008-07-02 by cmkwon, MySQL 지원 구현 - 
//	BOOL bRet = i_pODBCStmt->ExecuteQuery("SELECT * FROM ti_ItemMixingInfo WITH (NOLOCK)");

// 2008-08-27 by cmkwon, 날쿼리를 Procedure로 수정 - 
//	BOOL bRet = i_pODBCStmt->ExecuteQuery(QUERY_080702_0058);
	...
	// Bind Columns
	SQLBindCol(i_pODBCStmt->m_hstmt,  1, SQL_C_LONG   , &retMixingInfo.TargetItemNum, 0, &cb1);
	SQLBindCol(i_pODBCStmt->m_hstmt,  2, SQL_C_PROB10K, &retMixingInfo.MixingProbability, 0, &cb2);
	SQLBindCol(i_pODBCStmt->m_hstmt,  3, SQL_C_LONG   , &retMixingInfo.MixingCost, 0, &cb3);
	SQLBindCol(i_pODBCStmt->m_hstmt,  4, SQL_C_LONG   , &retMixingInfo.SourceItem[0].ItemNum, 0, &cb4);
	SQLBindCol(i_pODBCStmt->m_hstmt,  5, SQL_C_LONG   , &retMixingInfo.SourceItem[0].Count, 0, &cb5);
	SQLBindCol(i_pODBCStmt->m_hstmt,  6, SQL_C_LONG   , &retMixingInfo.SourceItem[1].ItemNum, 0, &cb6);
	SQLBindCol(i_pODBCStmt->m_hstmt,  7, SQL_C_LONG   , &retMixingInfo.SourceItem[1].Count, 0, &cb7);
	SQLBindCol(i_pODBCStmt->m_hstmt,  8, SQL_C_LONG   , &retMixingInfo.SourceItem[2].ItemNum, 0, &cb8);
	SQLBindCol(i_pODBCStmt->m_hstmt,  9, SQL_C_LONG   , &retMixingInfo.SourceItem[2].Count, 0, &cb9);
	SQLBindCol(i_pODBCStmt->m_hstmt, 10, SQL_C_LONG   , &retMixingInfo.SourceItem[3].ItemNum, 0, &cb10);
	SQLBindCol(i_pODBCStmt->m_hstmt, 11, SQL_C_LONG   , &retMixingInfo.SourceItem[3].Count, 0, &cb11);
	SQLBindCol(i_pODBCStmt->m_hstmt, 12, SQL_C_LONG   , &retMixingInfo.SourceItem[4].ItemNum, 0, &cb12);
	SQLBindCol(i_pODBCStmt->m_hstmt, 13, SQL_C_LONG   , &retMixingInfo.SourceItem[4].Count, 0, &cb13);
	...
	*/
	...
	int iMixingInfoToolSize = 0;
	int iMixingElementToolSize = 0;
	...
	iMixingInfoToolSize = vectorMixingInfoTool.size();
	iMixingElementToolSize = vectorMixingElementTool.size();
...
struct Level2RareItemInfo_Sort_Object: binary_function<RARE_ITEM_INFO*, RARE_ITEM_INFO*, bool>
{
	bool operator()(RARE_ITEM_INFO *pRareItemInfo1, RARE_ITEM_INFO *pRareItemInfo2)
	{
        return pRareItemInfo1->Probability < pRareItemInfo2->Probability;
    };
};

int CAtumDBHelper::LoadRareItemInfo(CODBCStatement *i_pODBCStmt
									, ez_map<INT, RARE_ITEM_INFO> *o_pMapRareItemInfo
									, CLocalization *i_pLocalization
									, ez_map<string, RARE_ITEM_INFO> *o_pMapRareItemInfoName
									, ez_map<BYTE, vector<RARE_ITEM_INFO* > > *o_pMapLevel2RareItemInfo)
{
	// clear map
...
//	BOOL bRet = i_pODBCStmt->ExecuteQuery(QUERY_080702_0059);
	...
	while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA)
	{
		...
		i_pLocalization->RareItemInfoLocalization(rareItemInfo.CodeNum, rareItemInfo.Name);
	...
	if (o_pMapLevel2RareItemInfo != NULL)
	{
		...
		///////////////////////////////////////////////////////////////////////////////
		// 각 레벨에 가능한 레어리스트를 확률 오름차순으로 정렬
		for (i = 1; i <= CHARACTER_MAX_LEVEL; i++)
		{
// 2007-12-07 by cmkwon, 레어 시스템 수정 - 정렬하지 않음
//			vector<RARE_ITEM_INFO*> *pTmpVector	= o_pMapLevel2RareItemInfo->findEZ_ptr(i);
//			if(pTmpVector->size() > 1)
//			{
//				sort(pTmpVector->begin(), pTmpVector->end(), Level2RareItemInfo_Sort_Object());
//			}

// 2007-12-07 by cmkwon, 시스템 로그 수정
//			char szLog[1024]; MEMSET_ZERO(szLog, 1024);
//			g_pGlobal->WriteSystemLogEX(FALSE, "\r\n\r\nLevel %d\r\n", i);
//			for (int j = 0; j < pTmpVector->size(); j++)
//			{
//				sprintf(&szLog[strlen(szLog)], "   %20s(%4d)", (*pTmpVector)[j]->Name, (*pTmpVector)[j]->Probability);
//				if(j!= 0 && j %5 == 0)
//				{
//					g_pGlobal->WriteSystemLogEX(TRUE, "%s\r\n", szLog);
//					MEMSET_ZERO(szLog, 1024);
//				}
//			}
//			g_pGlobal->WriteSystemLogEX(TRUE, "%s\r\n", szLog);
		}
...
int CAtumDBHelper::LoadAllBUILDINGNPC(CODBCStatement *i_pODBCStmt, vector<BUILDINGNPC> *o_pVectorBuildingNPC, CLocalization *i_pLocalization)
{
	// clear vector
...
//	BOOL bRet = i_pODBCStmt->ExecuteQuery(QUERY_080702_0061);
	...
	while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA)
	{
		// 2005-05-24 by cmkwon
		i_pLocalization->BuildingNPCLocalization(retBuildingNPC.BuildingIndex, retBuildingNPC.NPCName, retBuildingNPC.GreetingTalk);
...
int CAtumDBHelper::Load_MEX_MONSTER_INFO(CODBCStatement *i_pODBCStmt, vector<MEX_MONSTER_INFO> *o_pVectorMexMonsterInfo, CLocalization *i_pLocalization)
{
	// clear vector
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
int CAtumDBHelper::LoadHPActionByDB(CODBCStatement *i_pODBCStmt, ez_map<INT, vectHPAction> * o_pMapHPAction, CLocalization *i_pLocalization) {
	...
	{
		// 2005-05-23 by cmkwon, 현지화
		i_pLocalization->HPActionLocalization(SDBHPAction.HPActionUID, SDBHPAction.PreHPTalk, SDBHPAction.HPTalk);// 2009-09-09 ~ 2010-02-26 by dhjin, 인피니티 - *.cfg파일 추가
...
{
	MEMSET_ZERO(o_pServiInfo, sizeof(*o_pServiInfo));
	MEMSET_ZERO(io_pServGroup->ServerGroupNameforRK, SIZE_MAX_SERVER_NAME);
...
BOOL CAtumDBHelper::WRK_LevelLoadRanking(CODBCStatement *i_pODBCStmt, INT i_ServiUID, BYTE i_byRankingScope, mtvectSWRK_LEVEL_FOR_DB *o_pvectRankerList)
{
	...
	while(TRUE)
	{
		MEMSET_ZERO(&tmRanker, sizeof(tmRanker));
		MEMSET_ZERO(&sqlTime, sizeof(sqlTime));
...
BOOL CAtumDBHelper::WRK_LevelInsertRanking(CODBCStatement *i_pODBCStmt, SWRK_SERVICE_INFO *i_pServiInfo, BYTE i_byRankingScope, mtvectSWRK_LEVEL_FOR_DB *i_pvectRankerList)
{
	...
	for(; itr != i_pvectRankerList->end(); itr++)
	{
		...
		char szLevelUpTime[SIZE_MAX_SQL_DATETIME_STRING];	MEMSET_ZERO(szLevelUpTime, SIZE_MAX_SQL_DATETIME_STRING);
...
BOOL CAtumDBHelper::WRK_FameLoadRanking(CODBCStatement *i_pODBCStmt, INT i_ServiUID, BYTE i_byRankingScope, mtvectSWRK_FAME_FOR_DB *o_pvectRankerList)
{
	...
	cb[1] = cb[2] = cb[3] = cb[4] = cb[5] = cb[6] = cb[7] = cb[8] = cb[9] = cb[10] = SQL_NTS;
	SQLBindCol(hstmt, 1, SQL_C_LONG, &tmRanker.ServiceUID, 0,									&cb[1]);
	SQLBindCol(hstmt, 2, SQL_C_UTINYINT, &tmRanker.RankingScope, 0,								&cb[2]);
	SQLBindCol(hstmt, 3, SQL_C_LONG, &tmRanker.ServerGroupID, 0,								&cb[3]);	
	SQLBindCol(hstmt, 4, SQL_C_CHAR, tmRanker.ServerGroupNameforRK, SIZE_MAX_SERVER_NAME,		&cb[4]);	
...
BOOL CAtumDBHelper::WRK_PVPLoadRanking(CODBCStatement *i_pODBCStmt, INT i_ServiUID, BYTE i_byRankingScope, mtvectSWRK_PVP_FOR_DB *o_pvectRankerList)
{
	...
	cb[1] = cb[2] = cb[3] = cb[4] = cb[5] = cb[6] = cb[7] = cb[8] = cb[9] = cb[10] = cb[11] = cb[12] = SQL_NTS;
	SQLBindCol(hstmt, 1, SQL_C_LONG, &tmRanker.ServiceUID, 0,									&cb[1]);
	SQLBindCol(hstmt, 2, SQL_C_UTINYINT, &tmRanker.RankingScope, 0,								&cb[2]);
	SQLBindCol(hstmt, 3, SQL_C_LONG, &tmRanker.ServerGroupID, 0,								&cb[3]);	
	SQLBindCol(hstmt, 4, SQL_C_CHAR, tmRanker.ServerGroupNameforRK, SIZE_MAX_SERVER_NAME,		&cb[4]);	
...
int CAtumDBHelper::LoadMapInfo(CODBCStatement *i_pODBCStmt, vectorMAP_INFO *o_mapMapInfo, CLocalization *i_pLocalization)
{
	// clear vector
	o_mapMapInfo->clear();
	...
	SQLINTEGER		arrCB[54] = {SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS
								...
								,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS
								,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS
								,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS};		// 2009-09-09 ~ 2010 by dhjin, 인피니티 - 
	MAP_INFO		retMapInfo;

// 2008-07-02 by cmkwon, MySQL 지원 구현 - 
//	BOOL bRet = i_pODBCStmt->ExecuteQuery("SELECT * FROM ti_MapInfo WITH (NOLOCK)");

// 2008-08-27 by cmkwon, 날쿼리를 Procedure로 수정 - 
//	BOOL bRet = i_pODBCStmt->ExecuteQuery(QUERY_080702_0064);
	...
	{
		// 2005-05-23 by cmkwon, 현지화
		i_pLocalization->MapInfoLocalization(retMapInfo.MapIndex, retMapInfo.MapName, retMapInfo.MapDescription);	// 2009-09-09 ~ 2010-02-26 by dhjin, 인피니티 - *.cfg파일 추가
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
int CAtumDBHelper::LoadMysteryItemDropInfo(mtmapINT2MYSTERY_ITEM_DROP*o_pmmapMysteryItemDropList, CODBCStatement *i_pODBCStmt, ez_map<INT, ITEM*> *i_pemapItemInfoList, int i_nMGServerID)
{
	...
	**************************************************************************/
	...
	MEMSET_ZERO(&StartDTime, sizeof(SQL_TIMESTAMP_STRUCT));		// 2008-11-04 by dhjin, 럭키머신
	...
	int nCnts = 0;
	MEMSET_ZERO(&retMysteryDrop, sizeof(retMysteryDrop));
	while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA)
	{
			...
			|| retMysteryDrop.MinCount > retMysteryDrop.MaxCount)
		{
			...
			sprintf(szSystemLog, "[ERROR] CAtumDBHelper::LoadMysteryItemDropInfo_ error !!, pItemInfo(0x%X) MysteryItemDropNum(%8d) ReqLevel(%3d~%3d) DropItemNum(%8d) DropCount(%4d~%4d)\r\n"
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
int CAtumDBHelper::LoadLuckyMachineOmi(CODBCStatement *i_pODBCStmt, vector<LUCKY_MACHINE_OMI> *o_pvectLuckyMachine, CLocalization *i_pLocalization)
{
	...
	**************************************************************************/
	...
	MEMSET_ZERO(&retLuckyMachine, sizeof(LUCKY_MACHINE_OMI));	
	int nCnts = 0;
	while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA)
	{
		i_pLocalization->LuckyMachineLocalization(retLuckyMachine.MachineNum, retLuckyMachine.szDescription);
...
int CAtumDBHelper::DBLoadPetBaseDataInfo( CODBCStatement *i_pODBCStmt , vectorPetDataInfo* o_PetDataInfo )
{
	...
	MEMSET_ZERO(&tmPetData, sizeof(tPET_BASE_ALL_DATA));
...
// 	SQLBindCol(i_pODBCStmt->m_hstmt,	6,	SQL_C_LONG,		&tmPetData.BaseData.EnableLevel,		0, &arrCB[5]);
	...
	SQLBindCol(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_C_LONG,	&tmPetData.BaseData.PetKind,			0,					&arrCB[iCBCount]); iCBCount++;
	SQLBindCol(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_C_BIT,		&tmPetData.BaseData.EnableName,			0,					&arrCB[iCBCount]); iCBCount++;
	SQLBindCol(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_C_BIT,		&tmPetData.BaseData.EnableLevel,		0,					&arrCB[iCBCount]); iCBCount++;

	SQLBindCol(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_C_LONG,	&tmPetData.BaseData.MaxLevel,			0,					&arrCB[iCBCount]); iCBCount++;
	SQLBindCol(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_C_LONG,	&tmPetData.BaseData.BaseSocketCount,	0,					&arrCB[iCBCount]); iCBCount++;
...
// 	};
	...
	tPET_LEVEL_DATA	tmPetLevelData;
		MEMSET_ZERO(&tmPetLevelData, sizeof(tmPetLevelData));
...
// 		SQLBindCol( i_pODBCStmt->m_hstmt,	shColumnNum,	SQL_C_LONG,		&tmPetLevelData.PetSkillItemIndex[5],	0, &arrCB[11] ); shColumnNum++;
		...
		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_LONG,		&tmPetLevelData.PetIndex,			0,	&arrCB[shColumnNum]); shColumnNum++;
		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_LONG,		&tmPetLevelData.Level,				0,	&arrCB[shColumnNum]); shColumnNum++;
		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_DOUBLE,	&tmPetLevelData.NeedExp,			0,	&arrCB[shColumnNum]); shColumnNum++;
		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_LONG,		&tmPetLevelData.UseWeaponIndex,		0,	&arrCB[shColumnNum]); shColumnNum++;
		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_UTINYINT,	&tmPetLevelData.SlotCountSkill,		0,	&arrCB[shColumnNum]); shColumnNum++;

		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_UTINYINT,	&tmPetLevelData.SlotCountSocket,	0,	&arrCB[shColumnNum]); shColumnNum++;
		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_UTINYINT,	&tmPetLevelData.KitLevelHP,			0,	&arrCB[shColumnNum]); shColumnNum++;
		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_UTINYINT,	&tmPetLevelData.KitLevelShield,		0,	&arrCB[shColumnNum]); shColumnNum++;
		SQLBindCol(i_pODBCStmt->m_hstmt, (shColumnNum + 1), SQL_C_UTINYINT,	&tmPetLevelData.KitLevelSP,			0,	&arrCB[shColumnNum]); shColumnNum++;
		// end 2011-08-17 by hskim, 파트너 시스템 2차 - 자료 구조 결정
		///////////////////////////////////////////////////////////////////////////////////////
		...
		while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA) 
		{
			...
			MEMSET_ZERO(&tmPetLevelData, sizeof(tPET_LEVEL_DATA));
...
/// \return		
/////////////////////////////////////////////////////////////////////////////////////////////////
int CAtumDBHelper::DBLoadOperatorDataInfo(CODBCStatement *i_pODBCStmt, vectorOperatorInfo* o_OperatorInfo, CLocalization *i_pLocalization)
{
	int rtn = 0;
	RETCODE	ret;
...
/* int ActionType, int Itemnum, int FunctionIndex, double FunctionValue, int SourceIndex, char ActionDesc[128]; */
	...
	while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA) 
	{
		// 2010-12-03 by shcho, 펫 시스템 관련 스트링 로컬리제이션 추가 -  현지화 처리
		i_pLocalization->PetOperatorActionInfoLocalization(tmOpData.Itemnum,tmOpData.FunctionIndex,tmOpData.ActionDesc);
	...
	{	
		...
		*******************************************************************************************/
		...
		{	
			...
			MEMSET_ZERO(&tmTriggerCrystalBuff, sizeof(ptmTriggerCrystalBuff));
...
// 2013-08-14 by jhseol, 거점전 리뉴얼 - NGC 거점 : NGC거점전 생성시간 가져오기
///////////////////////////////////////////////////////////////////////////////
/// \fn			void CAtumDBHelper::DBLoadTriggerNGCSPCreateTime(CODBCStatement *i_pODBCStmt, ATUM_DATE_TIME *i_pNGCSPCreateTime)
/// \brief		NGC 거점전 생성시간 가져오는 함수
/// \author		jhseol
/// \date		2013-08-14
/// \warning	
/// \param		
/// \return		
///////////////////////////////////////////////////////////////////////////////
void CAtumDBHelper::DBLoadTriggerNGCSPCreateTime(CODBCStatement *i_pODBCStmt, ATUM_DATE_TIME *i_pNGCSPCreateTime)
{
	/*******************************************************************************************
	-------------------------------------------------------------------------------
	-- PROCEDURE NAME	: dbo.atum_LoadNGCSPCreateTime
	-- DESC				: // 2013-08-14 by jhseol, 거점전 리뉴얼 - NGC 거점 : NGC거점전 생성시간 가져오기
	--------------------------------------------------------------------------------
	CREATE PROCEDURE dbo.atum_LoadNGCSPCreateTime
	--WITH EXECUTE AS 'proexe'
	AS
	BEGIN
		SELECT NGCSPCreateTime
		FROM dbo.td_NGCSPCreateTime
	END
	GO
	*******************************************************************************************/
	if(FALSE == i_pODBCStmt->ExecuteQuery(PROCEDURE_130814_0005))
	{
		g_pGlobal->WriteSystemLogEX(TRUE, "[DB ERROR] CAtumDBHelper::DBLoadTriggerNGCSPCreateTime call PROCEDURE_130814_0005\r\n");
		i_pODBCStmt->FreeStatement();
		return;
	}
	...
	if ( SQLFetch(i_pODBCStmt->m_hstmt) != SQL_NO_DATA )
	{	
		*i_pNGCSPCreateTime = tmCreateTime;
	}
...
///////////////////////////////////////////////////////////////////////////////
/// \fn			void CAtumDBHelper::DBInsertTriggerNGCSPCreateTime(CODBCStatement *i_pODBCStmt, ATUM_DATE_TIME i_NGCSPCreateTime)
/// \brief		NGC 거점전 생성시간 저장하는 함수
/// \author		jhseol
/// \date		2013-08-14
/// \warning	
/// \param		
/// \return		
///////////////////////////////////////////////////////////////////////////////
void CAtumDBHelper::DBInsertTriggerNGCSPCreateTime(CODBCStatement *i_pODBCStmt, ATUM_DATE_TIME i_NGCSPCreateTime)
{
	/*******************************************************************************************
	-------------------------------------------------------------------------------
	-- PROCEDURE NAME	: dbo.atum_InsertNGCSPCreateTime
	-- DESC				: // 2013-08-14 by jhseol, 거점전 리뉴얼 - NGC 거점 : NGC 거점전 생성시간 저장하는 함수
	--------------------------------------------------------------------------------
	CREATE PROCEDURE dbo.atum_InsertNGCSPCreateTime
	--WITH EXECUTE AS 'proexe'
	AS
	BEGIN
		DELETE dbo.td_NGCSPCreateTime
		INSERT NGCSPCreateTime
		FROM dbo.td_NGCSPCreateTime
	END
	GO
	*******************************************************************************************/

	char tmCreateTime[SIZE_MAX_SQL_DATETIME_STRING] = {0,};
	sprintf(tmCreateTime, "%d-%02d-%02d %02d:%02d:0.000", i_NGCSPCreateTime.Year, i_NGCSPCreateTime.Month, i_NGCSPCreateTime.Day, i_NGCSPCreateTime.Hour, i_NGCSPCreateTime.Minute);
	SQLBindParameter(i_pODBCStmt->m_hstmt, 1	, SQL_PARAM_INPUT, SQL_C_CHAR, SQL_VARCHAR, SIZE_MAX_SQL_DATETIME_STRING, 0, tmCreateTime, 0, NULL);

	if(FALSE == i_pODBCStmt->ExecuteQuery(PROCEDURE_130814_0006))
	{
		g_pGlobal->WriteSystemLogEX(TRUE, "[DB ERROR] CAtumDBHelper::DBInsertTriggerNGCSPCreateTime call PROCEDURE_130814_0006\r\n");
	}
	i_pODBCStmt->FreeStatement();
	return;
}
// end 2013-08-14 by jhseol, 거점전 리뉴얼 - NGC 거점 : NGC거점전 생성시간 가져오기

// start 2012-03-13 by hskim, 현지화 관련 DB 구조 변경
///////////////////////////////////////////////////////////////////////////////
/// \fn			int CAtumDBHelper::SaveOverlapItem(CODBCStatement *i_pODBCStmt, vectorTriggerNGCInflWarMonsterGroup *i_pTriggerNGCInflWarMonsterGroup, HWND hWnd)
/// \brief		// 2012-03-13 by hskim, 현지화 관련 DB 구조 변경
/// \author		hskim
/// \date		2012-03-13
/// \warning	
/// \param		
...
int CAtumDBHelper::SaveOverlapItem(CODBCStatement *i_pODBCStmt, vectorOverlapItem *i_pOverlapItem, HWND hWnd)
{
	...
	SendMessage(hWnd, WM_PROGRESSBAR_RANGE, 0, ((LPARAM)i_pOverlapItem->size() - 1));

	//Insert
	int nObjects = 0;
	SOVERLAP_ITEM *pInfo;
	vectorOverlapItem::iterator itr = i_pOverlapItem->begin();
	SQLRETURN	RET;

	int a = i_pOverlapItem->size();

	for(; itr != i_pOverlapItem->end(); itr++) 
	{
		pInfo = &*itr;

		RET=SQLBindParameter(i_pODBCStmt->m_hstmt, 1, SQL_PARAM_INPUT, SQL_C_SLONG,		SQL_INTEGER,	0, 0, &pInfo->ItemNum,			0, &arrCB[0]);
		RET=SQLBindParameter(i_pODBCStmt->m_hstmt, 2, SQL_PARAM_INPUT, SQL_C_SLONG,		SQL_INTEGER,	0, 0, &pInfo->CashPrice,		0, &arrCB[1]);
		RET=SQLBindParameter(i_pODBCStmt->m_hstmt, 3, SQL_PARAM_INPUT, SQL_C_SLONG,		SQL_INTEGER,	0, 0, &pInfo->Tab,				0, &arrCB[2]);
		RET=SQLBindParameter(i_pODBCStmt->m_hstmt, 4, SQL_PARAM_INPUT, SQL_C_SLONG,		SQL_INTEGER,	0, 0, &pInfo->ItemAttribute,	0, &arrCB[3]);

		BOOL bRet = i_pODBCStmt->ExecuteQuery(PROCEDURE_120313_0003);
		i_pODBCStmt->FreeStatement();
		if (!bRet)	
		{
			// error
			char err[1024];
			sprintf(err, "ERROR line : OverlapITem ItemNum(%d) CashPrice(%d) Tab(%d) ItemAttribute(%d)!!", 
				pInfo->ItemNum, pInfo->CashPrice, pInfo->Tab, pInfo->ItemAttribute);
			MessageBox(NULL, err, "ti_OverlapItem", MB_OK);
			return -3;
		}
		nObjects++;
...
///////////////////////////////////////////////////////////////////////////////
/// \fn			int CAtumDBHelper::DBLoadOverlapItemInfo(CODBCStatement *i_pODBCStmt, void *i_pOverlapItem, BOOL ToolFlag /*= TRUE*/)
/// \brief		// 2012-03-13 by hskim, 현지화 관련 DB 구조 변경
/// \author		hskim
/// \date		2012-03-13
/// \warning	
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
int CAtumDBHelper::DBLoadOverlapItemInfo(CODBCStatement *i_pODBCStmt, void *i_pOverlapItem, BOOL ToolFlag /*= TRUE*/)
{
	int rtn = 0;
	RETCODE	ret;
	...
	{	
		vectorOverlapItem *ptmOverlapItem = (vectorOverlapItem *)(i_pOverlapItem);
	
		if(FALSE == i_pODBCStmt->ExecuteQuery(PROCEDURE_120313_0001))
		{
			g_pGlobal->WriteSystemLogEX(TRUE, "[DB ERROR] CAtumFieldDBManager::DBLoadOverlapItemInfo call ExecuteQuery(PROCEDURE_120313_0001\r\n");
		...
		SQLBindCol(i_pODBCStmt->m_hstmt,	1,	SQL_C_SLONG,	&tmOverlapItem.ItemNum,			0, &arrCB[0]);
		SQLBindCol(i_pODBCStmt->m_hstmt,	2,	SQL_C_SLONG,	&tmOverlapItem.CashPrice,		0, &arrCB[1]);
		SQLBindCol(i_pODBCStmt->m_hstmt,	3,	SQL_C_SLONG,	&tmOverlapItem.Tab,				0, &arrCB[2]);
		SQLBindCol(i_pODBCStmt->m_hstmt,	4,	SQL_C_SLONG,	&tmOverlapItem.ItemAttribute,	0, &arrCB[3]);

		while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA) 
		{	
			if( ptmOverlapItem != NULL )
			{
				ptmOverlapItem->push_back(tmOverlapItem);
			}
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
BOOL CAtumDBHelper::LoadInfluenceLeader(UID32_t *o_pVCNLeader, UID32_t *o_pANILeader, CODBCStatement *i_pOdbcStmt, int i_nMGServerID)
{
	BYTE			nInflTy;
	UID32_t			charUID;
	RETCODE			ret;
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
BOOL CAtumDBHelper::LoadInfluenceSub1Leader(UID32_t *o_pVCNSub1Leader, UID32_t *o_pANISub1Leader, CODBCStatement *i_pOdbcStmt, int i_nMGServerID)
{
	BYTE			nInflTy;
	UID32_t			charUID;
	RETCODE			ret;
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
BOOL CAtumDBHelper::LoadInfluenceSub2Leader(UID32_t *o_pVCNSub2Leader, UID32_t *o_pANISub2Leader, CODBCStatement *i_pOdbcStmt, int i_nMGServerID)
{
	BYTE			nInflTy;
	UID32_t			charUID;
	RETCODE			ret;
...
int CAtumDBHelper::LoadInfluenceWarInfo(CODBCStatement *i_pODBCStmt, vectDB_INFLUENCE_WAR_INFO *i_pvectDB_INFLUENCE_WAR_INFO)
{
	...
	SQLINTEGER				arrCB[57] = {SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS
											...
											,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS
											,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS
											,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS};	// 2009-03-10 by dhjin, 단계별 모선 시스템
...
//	BOOL bRet = i_pODBCStmt->ExecuteQuery(QUERY_080702_0072);
	...
	MEMSET_ZERO(&tmWarInfo, sizeof(tmWarInfo));
	while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA)
	{
...
//	BOOL bRet = i_pOdbcStmt->ExecuteQuery(QUERY_080702_0073);
	...
	MEMSET_ZERO(&tmEventMonster, sizeof(SEVENT_MONSTER));
	MEMSET_ZERO(&StartDTime, sizeof(SQL_TIMESTAMP_STRUCT));
	MEMSET_ZERO(&EndDTime, sizeof(SQL_TIMESTAMP_STRUCT));
	...
	while ( (ret = SQLFetch(i_pOdbcStmt->m_hstmt)) != SQL_NO_DATA)
	{
		...
		if(0 == i_nServerGroupID )
		{// 2008-04-17 by cmkwon, 모든 리스트를 추가한다.

			o_pEventMonsterList->push_back(tmEventMonster);
		}
		else if( (0 == tmEventMonster.ServerGroupID || i_nServerGroupID == tmEventMonster.ServerGroupID)
			&& tmEventMonster.EndDateTime > atCur )
		{// 2008-04-16 by cmkwon, 유효한 EventMonster 만을 추가
...
//end 2009. 10. 27 by jskim 진행률 확인
{
	SQLINTEGER	arrCB[80] = {SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,
							 ...
							 SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,
							 SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,
							 SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS};		// 2009-09-09 ~ 2010-02-10 by dhjin, 인피니티 - 발동류장착아이템
	...
	for(; itr != o_pItem->end(); itr++)
	{
		...
		// 2014-02-06 by jhseol, ti_item 테이블 0값 무시
		if ( 0 >= tmItem.ItemNum )
		{
			nObjects++;
			SendMessage(hWnd, WM_PROGRESSBAR_POS, 0, nObjects);
		...
		// end 2014-02-06 by jhseol, ti_item 테이블 0값 무시

		SQLBindParameter(i_pODBCStmt->m_hstmt, 1, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmItem.ItemNum, 0,						&arrCB[1]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 2, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.Kind, 0,						&arrCB[2]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 3, SQL_PARAM_INPUT, SQL_C_CHAR, SQL_VARCHAR, SIZE_MAX_ITEM_NAME, 0, tmItem.ItemName, 0,		&arrCB[3]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 4, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.AbilityMin, 0,						&arrCB[4]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 5, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.AbilityMax, 0,						&arrCB[5]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 6, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ReqRace, 0,					&arrCB[6]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 7, SQL_PARAM_INPUT, SQL_C_SHORT, SQL_SMALLINT, 0, 0, &tmItem.ReqGearStat.AttackPart, 0,		&arrCB[7]);			// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 8, SQL_PARAM_INPUT, SQL_C_SHORT, SQL_SMALLINT, 0, 0, &tmItem.ReqGearStat.DefensePart, 0,		&arrCB[8]);			// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 9, SQL_PARAM_INPUT, SQL_C_SHORT, SQL_SMALLINT, 0, 0, &tmItem.ReqGearStat.FuelPart,	0,		&arrCB[9]);			// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 10, SQL_PARAM_INPUT, SQL_C_SHORT, SQL_SMALLINT, 0, 0, &tmItem.ReqGearStat.SoulPart, 0,		&arrCB[10]);		// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 11, SQL_PARAM_INPUT, SQL_C_SHORT, SQL_SMALLINT, 0,0, &tmItem.ReqGearStat.ShieldPart,	0,		&arrCB[11]);		// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 12, SQL_PARAM_INPUT, SQL_C_SHORT, SQL_SMALLINT, 0,0, &tmItem.ReqGearStat.DodgePart,  0,		&arrCB[12]);		// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 13, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_INTEGER, 0, 0, &tmItem.ReqUnitKind,  0,				&arrCB[13]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 14, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.ReqMinLevel,  0,				&arrCB[14]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 15, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.ReqMaxLevel,  0,				&arrCB[15]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 16, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.ReqItemKind,  0,				&arrCB[16]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 17, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.Weight,  0,					&arrCB[17]);

		// 2010-07-19 by dhjin, 확률 수식 변경	// 2009-12-17 by cmkwon, 데미지 계산식 관련한 필드(방어력,회피,피어스,확률)에 255이상 값을 설정 가능하게 수정 - 공격확률
		SQLBindParameter(i_pODBCStmt->m_hstmt, 18, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.HitRate,  0,					&arrCB[18]);

		SQLBindParameter(i_pODBCStmt->m_hstmt, 19, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.Defense,  0,					&arrCB[19]);
		
		// 2010-07-19 by dhjin, 확률 수식 변경 // 2009-12-17 by cmkwon, 데미지 계산식 관련한 필드(방어력,회피,피어스,확률)에 255이상 값을 설정 가능하게 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 20, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.FractionResistance,  0,		&arrCB[20]);

		SQLBindParameter(i_pODBCStmt->m_hstmt, 21, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.NaturalFaction,  0,			&arrCB[21]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 22, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.SpeedPenalty,  0,			&arrCB[22]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 23, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.Range,  0,					&arrCB[23]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 24, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.Position,  0,				&arrCB[24]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 25, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.Scarcity,  0,				&arrCB[25]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 26, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.Endurance,  0,					&arrCB[26]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 27, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.AbrasionRate,  0,			&arrCB[27]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 28, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.Charging,  0,					&arrCB[28]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 29, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.Luck,  0,					&arrCB[29]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 30, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.MinTradeQuantity,  0,			&arrCB[30]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 31, SQL_PARAM_INPUT, SQL_C_ULONG, SQL_INTEGER, 0, 0, &tmItem.Price,  0,						&arrCB[31]);		// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 32, SQL_PARAM_INPUT, SQL_C_ULONG, SQL_INTEGER, 0, 0, &tmItem.CashPrice,  0,					&arrCB[32]);		// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 33, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ArrDestParameter[0],  0,		&arrCB[33]);		// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원)
		SQLBindParameter(i_pODBCStmt->m_hstmt, 34, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.ArrParameterValue[0],  0,			&arrCB[34]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 35, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ArrDestParameter[1],  0,		&arrCB[35]);		// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원)
		SQLBindParameter(i_pODBCStmt->m_hstmt, 36, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.ArrParameterValue[1],  0,			&arrCB[36]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 37, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ArrDestParameter[2],  0,		&arrCB[37]);		// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원)
		SQLBindParameter(i_pODBCStmt->m_hstmt, 38, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.ArrParameterValue[2],  0,			&arrCB[38]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 39, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ArrDestParameter[3],  0,		&arrCB[39]);		// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원)
		SQLBindParameter(i_pODBCStmt->m_hstmt, 40, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.ArrParameterValue[3],  0,			&arrCB[40]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 41, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ArrDestParameter[4],  0,		&arrCB[41]);		// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원)
		SQLBindParameter(i_pODBCStmt->m_hstmt, 42, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.ArrParameterValue[4],  0,			&arrCB[42]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 43, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ArrDestParameter[5],  0,		&arrCB[43]);		// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원)
		SQLBindParameter(i_pODBCStmt->m_hstmt, 44, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.ArrParameterValue[5],  0,			&arrCB[44]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 45, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ArrDestParameter[6],  0,		&arrCB[45]);		// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원)
		SQLBindParameter(i_pODBCStmt->m_hstmt, 46, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.ArrParameterValue[6],  0,			&arrCB[46]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 47, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ArrDestParameter[7],  0,		&arrCB[47]);		// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원)
		SQLBindParameter(i_pODBCStmt->m_hstmt, 48, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.ArrParameterValue[7],  0,			&arrCB[48]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 49, SQL_PARAM_INPUT, SQL_C_ULONG, SQL_INTEGER, 0, 0, &tmItem.ReAttacktime,  0,				&arrCB[49]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 50, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmItem.Time,  0,						&arrCB[50]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 51, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.RepeatTime,  0,				&arrCB[51]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 52, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.Material,  0,					&arrCB[52]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 53, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ReqMaterial,  0,				&arrCB[53]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 54, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.RangeAngle,  0,					&arrCB[54]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 55, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.UpgradeNum,  0,				&arrCB[55]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 56, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmItem.LinkItem,  0,					&arrCB[56]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 57, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.MultiTarget,  0,				&arrCB[57]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 58, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ExplosionRange,  0,			&arrCB[58]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 59, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.ReactionRange,  0,			&arrCB[59]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 60, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.ShotNum,  0,					&arrCB[60]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 61, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.MultiNum,  0,				&arrCB[61]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 62, SQL_PARAM_INPUT, SQL_C_USHORT, SQL_SMALLINT, 0, 0, &tmItem.AttackTime,  0,				&arrCB[62]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 63, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.ReqSP,  0,					&arrCB[63]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 64, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmItem.SummonMonster,  0,				&arrCB[64]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 65, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmItem.NextSkill,  0,					&arrCB[65]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 66, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.SkillLevel,  0,				&arrCB[66]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 67, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.SkillHitRate,  0,			&arrCB[67]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 68, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.SkillType,  0,				&arrCB[68]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 69, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.SkillTargetType,  0,			&arrCB[69]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 70, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.Caliber,  0,					&arrCB[70]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 71, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.OrbitType,  0,				&arrCB[71]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 72, SQL_PARAM_INPUT, SQL_C_UBIGINT, SQL_BIGINT, 0, 0, &tmItem.ItemAttribute,  0,				&arrCB[72]);	// 2009-09-23 by cmkwon, Excel to DB 관련 자료형 버그 수정 - 
		SQLBindParameter(i_pODBCStmt->m_hstmt, 73, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmItem.BoosterAngle,  0,					&arrCB[73]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 74, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmItem.CameraPattern,  0,				&arrCB[74]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 75, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmItem.SourceIndex,  0,				&arrCB[75]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 76, SQL_PARAM_INPUT, SQL_C_CHAR, SQL_VARCHAR, SIZE_MAX_ITEM_DESCRIPTION, 0, tmItem.Description,  0,	&arrCB[76]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 77, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmItem.EnchantCheckDestParam,  0,	&arrCB[77]);	// 2009-09-09 ~ 2010-02-10 by dhjin, 인피니티 - 발동류장착아이템
		SQLBindParameter(i_pODBCStmt->m_hstmt, 78, SQL_PARAM_INPUT, SQL_C_ULONG, SQL_INTEGER, 0, 0, &tmItem.InvokingDestParamID,  0,		&arrCB[78]);	// 2009-09-09 ~ 2010-02-10 by dhjin, 인피니티 - 발동류장착아이템
		SQLBindParameter(i_pODBCStmt->m_hstmt, 79, SQL_PARAM_INPUT, SQL_C_ULONG, SQL_INTEGER, 0, 0, &tmItem.InvokingDestParamIDByUse,  0,	&arrCB[79]);	// 2009-09-09 ~ 2010-02-10 by dhjin, 인피니티 - 발동류장착아이템
...
//end 2009. 10. 27 by jskim 진행률 확인
{
	SQLINTEGER	arrCB[59] = {SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,
							 ...
							 SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,
							 SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,
							 SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS,SQL_NTS,SQL_NTS, SQL_NTS };		// 2011-05-23 by hskim, 인피니티 3차 - 웨이포인트 구현 - WayPointPattern 필드 추가
...
// 		ret = SQLBindParameter(i_pODBCStmt->m_hstmt, 6, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &temp_Info.EnableLevel,						0, &arrCB[5]);
		...
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER,	0,					0, &temp_Info.PetIndex,			0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_CHAR, SQL_VARCHAR,	SIZE_MAX_PET_NAME,	0, &temp_Info.PetName,			0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER,	0,					0, &temp_Info.PetKind,			0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_BIT,	SQL_SMALLINT,	0,					0, &temp_Info.EnableName,		0, &arrCB[iCBCount]);	iCBCount++;

		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_BIT,	SQL_SMALLINT,	0,					0, &temp_Info.EnableLevel,		0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_LONG, SQL_SMALLINT,	0,					0, &temp_Info.MaxLevel,			0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_LONG, SQL_TINYINT,	0,					0, &temp_Info.BaseSocketCount,	0, &arrCB[iCBCount]);	iCBCount++;
		// end 2011-08-17 by hskim, 파트너 시스템 2차 - 자료 구조 결정
		///////////////////////////////////////////////////////////////////////////////////////	
...
// 		SQLBindParameter(i_pODBCStmt->m_hstmt, 13, SQL_PARAM_INPUT, SQL_C_LONG,		SQL_INTEGER, 0, 0, &temp_Info.PetAttackIndex,		0, &arrCB[12]);
		...
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_LONG,		SQL_INTEGER,	0, 0, &temp_Info.PetIndex,			0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_LONG,		SQL_INTEGER,	0, 0, &temp_Info.Level,				0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_DOUBLE,	SQL_FLOAT,		0, 0, &temp_Info.NeedExp,			0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_LONG,		SQL_INTEGER,	0, 0, &temp_Info.UseWeaponIndex,	0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_UTINYINT,	SQL_SMALLINT,	0, 0, &temp_Info.SlotCountSkill,	0, &arrCB[iCBCount]);	iCBCount++;

		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_UTINYINT,	SQL_SMALLINT,	0, 0, &temp_Info.SlotCountSocket,	0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_UTINYINT,	SQL_SMALLINT,	0, 0, &temp_Info.KitLevelHP,		0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_UTINYINT,	SQL_SMALLINT,	0, 0, &temp_Info.KitLevelShield,	0, &arrCB[iCBCount]);	iCBCount++;
		SQLBindParameter(i_pODBCStmt->m_hstmt, (iCBCount + 1), SQL_PARAM_INPUT, SQL_C_UTINYINT,	SQL_SMALLINT,	0, 0, &temp_Info.KitLevelSP,		0, &arrCB[iCBCount]);	iCBCount++;
...
void CAtumDBHelper::BindColITEM(SQLHSTMT &hstmt, ITEM &item, SQLINTEGER *cb)
{
	...
	SQLBindCol(hstmt,  3, SQL_C_CHAR    , item.ItemName					, SIZE_MAX_ITEM_NAME, &cb[3]);
	SQLBindCol(hstmt,  4, SQL_C_FLOAT   , &item.AbilityMin				, 0, &cb[4]);
	SQLBindCol(hstmt,  5, SQL_C_FLOAT   , &item.AbilityMax				, 0, &cb[5]);
	SQLBindCol(hstmt,  6, SQL_C_USHORT  , &item.ReqRace					, 0, &cb[6]);
	SQLBindCol(hstmt,  7, SQL_C_SHORT  , &item.ReqGearStat.AttackPart      , 0, &cb[7]);
	SQLBindCol(hstmt,  8, SQL_C_SHORT  , &item.ReqGearStat.DefensePart     , 0, &cb[8]);
	SQLBindCol(hstmt,  9, SQL_C_SHORT  , &item.ReqGearStat.FuelPart        , 0, &cb[9]);
	SQLBindCol(hstmt, 10, SQL_C_SHORT  , &item.ReqGearStat.SoulPart        , 0, &cb[10]);
	SQLBindCol(hstmt, 11, SQL_C_SHORT  , &item.ReqGearStat.ShieldPart      , 0, &cb[11]);
	SQLBindCol(hstmt, 12, SQL_C_SHORT  , &item.ReqGearStat.DodgePart       , 0, &cb[12]);
	SQLBindCol(hstmt, 13, SQL_C_USHORT  , &item.ReqUnitKind				, 0, &cb[13]);
	SQLBindCol(hstmt, 14, SQL_C_UTINYINT, &item.ReqMinLevel				, 0, &cb[14]);
	SQLBindCol(hstmt, 15, SQL_C_UTINYINT, &item.ReqMaxLevel				, 0, &cb[15]);
	SQLBindCol(hstmt, 16, SQL_C_UTINYINT, &item.ReqItemKind				, 0, &cb[16]);
	SQLBindCol(hstmt, 17, SQL_C_USHORT  , &item.Weight					, 0, &cb[17]);
	SQLBindCol(hstmt, 18, SQL_C_FLOAT	, &item.HitRate					, 0, &cb[18]);	// 2010-07-19 by dhjin, 확률 수식 변경		
	SQLBindCol(hstmt, 19, SQL_C_UTINYINT, &item.Defense					, 0, &cb[19]);
	SQLBindCol(hstmt, 20, SQL_C_FLOAT	, &item.FractionResistance		, 0, &cb[20]);	// 2010-07-19 by dhjin, 확률 수식 변경
	SQLBindCol(hstmt, 21, SQL_C_UTINYINT, &item.NaturalFaction			, 0, &cb[21]);	
	SQLBindCol(hstmt, 22, SQL_C_UTINYINT, &item.SpeedPenalty			, 0, &cb[22]);
	SQLBindCol(hstmt, 23, SQL_C_USHORT  , &item.Range					, 0, &cb[23]);
	SQLBindCol(hstmt, 24, SQL_C_UTINYINT, &item.Position				, 0, &cb[24]);
	SQLBindCol(hstmt, 25, SQL_C_UTINYINT, &item.Scarcity				, 0, &cb[25]);
	SQLBindCol(hstmt, 26, SQL_C_FLOAT   , &item.Endurance				, 0, &cb[26]);
	SQLBindCol(hstmt, 27, SQL_C_PROB256 , &item.AbrasionRate			, 0, &cb[27]);
	SQLBindCol(hstmt, 28, SQL_C_USHORT  , &item.Charging				, 0, &cb[28]);
	SQLBindCol(hstmt, 29, SQL_C_UTINYINT, &item.Luck					, 0, &cb[29]);
	SQLBindCol(hstmt, 30, SQL_C_USHORT  , &item.MinTradeQuantity		, 0, &cb[30]);
	SQLBindCol(hstmt, 31, SQL_C_ULONG   , &item.Price					, 0, &cb[31]);
	SQLBindCol(hstmt, 32, SQL_C_ULONG   , &item.CashPrice				, 0, &cb[32]);
	SQLBindCol(hstmt, 33, SQL_C_USHORT	, &item.ArrDestParameter[0]		, 0, &cb[33]);	// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원) - // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 34, SQL_C_FLOAT	, &item.ArrParameterValue[0]	, 0, &cb[34]);	// 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 35, SQL_C_USHORT	, &item.ArrDestParameter[1]		, 0, &cb[35]);	// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원) - // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 36, SQL_C_FLOAT   , &item.ArrParameterValue[1]	, 0, &cb[36]);	// 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 37, SQL_C_USHORT	, &item.ArrDestParameter[2]		, 0, &cb[37]);	// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원) - // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 38, SQL_C_FLOAT   , &item.ArrParameterValue[2]	, 0, &cb[38]);	// 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 39, SQL_C_USHORT	, &item.ArrDestParameter[3]		, 0, &cb[39]);	// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원) - // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 40, SQL_C_FLOAT   , &item.ArrParameterValue[3]	, 0, &cb[40]);	// 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 41, SQL_C_USHORT	, &item.ArrDestParameter[4]		, 0, &cb[41]);	// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원) - // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 42, SQL_C_FLOAT	, &item.ArrParameterValue[4]	, 0, &cb[42]);	// 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 43, SQL_C_USHORT	, &item.ArrDestParameter[5]		, 0, &cb[43]);	// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원) - // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 44, SQL_C_FLOAT   , &item.ArrParameterValue[5]	, 0, &cb[44]);	// 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 45, SQL_C_USHORT	, &item.ArrDestParameter[6]		, 0, &cb[45]);	// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원) - // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 46, SQL_C_FLOAT   , &item.ArrParameterValue[6]	, 0, &cb[46]);	// 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 47, SQL_C_USHORT	, &item.ArrDestParameter[7]		, 0, &cb[47]);	// 2011-08-01 by hskim, 파트너 시스템 2차 - 자료형 변경 (DestParameter - 255 -> 32767 지원) - // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 48, SQL_C_FLOAT   , &item.ArrParameterValue[7]	, 0, &cb[48]);	// 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 필드명을 배열로 변경 
	SQLBindCol(hstmt, 49, SQL_C_ULONG   , &item.ReAttacktime			, 0, &cb[49]);
	SQLBindCol(hstmt, 50, SQL_C_LONG    , &item.Time					, 0, &cb[50]);
	SQLBindCol(hstmt, 51, SQL_C_USHORT  , &item.RepeatTime				, 0, &cb[51]);
	SQLBindCol(hstmt, 52, SQL_C_USHORT  , &item.Material				, 0, &cb[52]);
	SQLBindCol(hstmt, 53, SQL_C_USHORT  , &item.ReqMaterial				, 0, &cb[53]);
	SQLBindCol(hstmt, 54, SQL_C_FLOAT   , &item.RangeAngle				, 0, &cb[54]);
	SQLBindCol(hstmt, 55, SQL_C_UTINYINT, &item.UpgradeNum				, 0, &cb[55]);
	SQLBindCol(hstmt, 56, SQL_C_SLONG   , &item.LinkItem				, 0, &cb[56]);
	SQLBindCol(hstmt, 57, SQL_C_UTINYINT, &item.MultiTarget				, 0, &cb[57]);
	SQLBindCol(hstmt, 58, SQL_C_USHORT  , &item.ExplosionRange			, 0, &cb[58]);
	SQLBindCol(hstmt, 59, SQL_C_USHORT  , &item.ReactionRange			, 0, &cb[59]);
	SQLBindCol(hstmt, 60, SQL_C_UTINYINT, &item.ShotNum					, 0, &cb[60]);
	SQLBindCol(hstmt, 61, SQL_C_UTINYINT, &item.MultiNum				, 0, &cb[61]);
	SQLBindCol(hstmt, 62, SQL_C_USHORT  , &item.AttackTime				, 0, &cb[62]);
	SQLBindCol(hstmt, 63, SQL_C_UTINYINT, &item.ReqSP					, 0, &cb[63]);
	SQLBindCol(hstmt, 64, SQL_C_SLONG   , &item.SummonMonster			, 0, &cb[64]);
	SQLBindCol(hstmt, 65, SQL_C_SLONG   , &item.NextSkill				, 0, &cb[65]);
	SQLBindCol(hstmt, 66, SQL_C_UTINYINT, &item.SkillLevel				, 0, &cb[66]);
	SQLBindCol(hstmt, 67, SQL_C_PROB256 , &item.SkillHitRate			, 0, &cb[67]);
	SQLBindCol(hstmt, 68, SQL_C_UTINYINT, &item.SkillType				, 0, &cb[68]);
	SQLBindCol(hstmt, 69, SQL_C_UTINYINT, &item.SkillTargetType			, 0, &cb[69]);
	SQLBindCol(hstmt, 70, SQL_C_UTINYINT, &item.Caliber					, 0, &cb[70]);
	SQLBindCol(hstmt, 71, SQL_C_UTINYINT, &item.OrbitType				, 0, &cb[71]);
	SQLBindCol(hstmt, 72, SQL_C_UBIGINT	, &item.ItemAttribute			, 0, &cb[72]);		// 2010-01-11 by cmkwon, 버그 수정 - 기존(SQL_C_ULONG)
	SQLBindCol(hstmt, 73, SQL_C_FLOAT	, &item.BoosterAngle			, 0, &cb[73]);
	SQLBindCol(hstmt, 74, SQL_C_LONG	, &item.CameraPattern			, 0, &cb[74]);
	SQLBindCol(hstmt, 75, SQL_C_LONG	, &item.SourceIndex				, 0, &cb[75]);
	cb[76] = SQL_NTS;
	SQLBindCol(hstmt, 76, SQL_C_CHAR    , item.Description         , SIZE_MAX_ITEM_DESCRIPTION, &cb[76]);
	SQLBindCol(hstmt, 77, SQL_C_UTINYINT, &item.EnchantCheckDestParam	, 0, &cb[77]);	// 2009-09-09 ~ 2010-02-10 by dhjin, 인피니티 - 발동류장착아이템
	SQLBindCol(hstmt, 78, SQL_C_ULONG	, &item.InvokingDestParamID		, 0, &cb[78]);	// 2009-09-09 ~ 2010-02-10 by dhjin, 인피니티 - 발동류장착아이템
...
void CAtumDBHelper::BindColCharacter(SQLHSTMT &hstmt, CHARACTER &character, CHARACTER_DB_EX &characterDBEX, SQLINTEGER *cb)
{
	...
	SQLBindCol(hstmt, 5, SQL_C_UTINYINT, &character.Gender, 0,							&cb[5]);
...
void CAtumDBHelper::BindColBossMonsterRewardInfo(SQLHSTMT &hstmt, BOSS_MONSTER_REWARD_INFO &ret, SQLINTEGER *cb)
{
	...
	SQLBindCol(hstmt, 3, SQL_C_LONG,	&ret.BossMonsterReward.nMaxPerson,		0,	&cb[2]);
	SQLBindCol(hstmt, 4, SQL_C_LONG,	&ret.BossMonsterReward.nTime,			0,	&cb[3]);
	SQLBindCol(hstmt, 5, SQL_C_LONG,	&ret.BossMonsterReward.ItemNum,			0,	&cb[4]);
}
...
// 2013-08-14 by jhseol, 거점전 리뉴얼 - ti_MonsterGrade 추가
///////////////////////////////////////////////////////////////////////////////
/// \fn			int CAtumDBHelper::SaveMonsterGrade(CODBCStatement *i_pODBCStmt, MONSTER_GRADE_LIST *o_pMonsterGradeList, HWND hWnd)
/// \brief		// 2009-07-09 by jwlee, 게임 정보 테이블 데이터 DB에 밀어넣기 툴 구현 - 
/// \author		jwlee
/// \date		2009-07-09 ~ 2009-07-09
/// \warning	
...
//end 2009. 10. 27 by jskim 진행률 확인
{
	...
	// 2009. 10. 27 by jskim 진행률 확인
	SendMessage(hWnd, WM_PROGRESSBAR_RANGE, 0, (LPARAM)(o_pMonsterGradeList->size() - 1));
	//end 2009. 10. 27 by jskim 진행률 확인
	//Insert ti_InfluenceWar
	int nObjects = 0;
	MONSTER_GRADE_LIST::iterator itr(o_pMonsterGradeList->begin());
	for(; itr != o_pMonsterGradeList->end(); itr++)
	{
		MONSTER_GRADE_INFO			tmMonsterGradeInfo;	
		tmMonsterGradeInfo	= *itr;
		
		// Bind Columns
		SQLBindParameter(i_pODBCStmt->m_hstmt, 1, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmMonsterGradeInfo.MonsterGeadeType, 0, 	&arrCB[1]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 2, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmMonsterGradeInfo.InflType, 0,			&arrCB[2]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 3, SQL_PARAM_INPUT, SQL_C_UTINYINT, SQL_TINYINT, 0, 0, &tmMonsterGradeInfo.Level, 0,				&arrCB[3]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 4, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmMonsterGradeInfo.MonsterNum, 0,			&arrCB[4]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 5, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmMonsterGradeInfo.BeforeMonsterNum, 0,		&arrCB[5]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 6, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmMonsterGradeInfo.AfterMonsterNum, 0,		&arrCB[6]);

		BOOL bRet = i_pODBCStmt->ExecuteQuery((char*)(PROCEDURE_130814_0004));
		i_pODBCStmt->FreeStatement();
		if (!bRet)
		{
			// error
			char err[1024];
			sprintf(err, "ERROR line : MonsterGeadeType(%d)   InflType(%d)   Level(%d)!!", tmMonsterGradeInfo.MonsterGeadeType, tmMonsterGradeInfo.InflType, tmMonsterGradeInfo.Level);
			MessageBox(NULL, err, "ti_MonsterGrade", MB_OK);
			return -3;
		}
		nObjects++;
		// 2009. 10. 27 by jskim 진행률 확인
...
// end 2013-08-14 by jhseol, 거점전 리뉴얼 - ti_MonsterGrade 추가

// 2013-08-14 by jhseol, 거점전 리뉴얼 - MonsterGradeList 로드
///////////////////////////////////////////////////////////////////////////////
/// \fn			int CAtumDBHelper::LoadMonsterGradeList(CODBCStatement *i_pODBCStmt, MONSTER_GRADE_LIST *i_pvectMONSTER_GRADE_LIST)
/// \brief		
/// \author		jhseol
/// \date		2013-08-14
/// \warning	
...
int CAtumDBHelper::LoadMonsterGradeList(CODBCStatement *i_pODBCStmt, MONSTER_GRADE_LIST *i_pvectMONSTER_GRADE_LIST)
{
	...
	// Bind Columns
	SQLBindCol(i_pODBCStmt->m_hstmt, 1, SQL_C_UTINYINT, &tmMONSTER_GRADE_INFO.MonsterGeadeType, 0,	&arrCB[1]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 2, SQL_C_UTINYINT, &tmMONSTER_GRADE_INFO.InflType, 0,			&arrCB[2]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 3, SQL_C_UTINYINT, &tmMONSTER_GRADE_INFO.Level, 0,				&arrCB[3]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 4, SQL_C_LONG, &tmMONSTER_GRADE_INFO.MonsterNum, 0,			&arrCB[4]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 5, SQL_C_LONG, &tmMONSTER_GRADE_INFO.BeforeMonsterNum, 0,		&arrCB[5]);
	SQLBindCol(i_pODBCStmt->m_hstmt, 6, SQL_C_LONG, &tmMONSTER_GRADE_INFO.AfterMonsterNum, 0,		&arrCB[6]);
	
	MEMSET_ZERO(&tmMONSTER_GRADE_INFO, sizeof(tmMONSTER_GRADE_INFO));
	while ( (ret = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA)
	{
		i_pvectMONSTER_GRADE_LIST->push_back(tmMONSTER_GRADE_INFO);
		MEMSET_ZERO(&tmMONSTER_GRADE_INFO, sizeof(tmMONSTER_GRADE_INFO));
	}
	i_pODBCStmt->FreeStatement();
	
	return i_pvectMONSTER_GRADE_LIST->size();
}
// end 2013-08-14 by jhseol, 거점전 리뉴얼 - MonsterGradeList 로드
...
int CAtumDBHelper::SaveBossReward(CODBCStatement *i_pODBCStmt, vectorBossMonsterReward *o_pBossRewardList, HWND hWnd)
{
	...
	SendMessage(hWnd, WM_PROGRESSBAR_RANGE, 0, (LPARAM)(o_pBossRewardList->size() - 1));
		
	int nObjects = 0;
	vectorBossMonsterReward::iterator itr(o_pBossRewardList->begin());
	for(; itr != o_pBossRewardList->end(); itr++)
	{
		BOSS_MONSTER_REWARD_INFO			tmBossReward;	
		tmBossReward	= *itr;
				
		// Bind Columns
		SQLBindParameter(i_pODBCStmt->m_hstmt, 1, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmBossReward.MonsterIndex,					0, 	&arrCB[1]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 2, SQL_PARAM_INPUT, SQL_C_FLOAT, SQL_FLOAT, 0, 0, &tmBossReward.BossMonsterReward.fMinDamege,	0,	&arrCB[2]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 3, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmBossReward.BossMonsterReward.nMaxPerson,	0,	&arrCB[3]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 4, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmBossReward.BossMonsterReward.nTime,		0,	&arrCB[4]);
		SQLBindParameter(i_pODBCStmt->m_hstmt, 5, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, &tmBossReward.BossMonsterReward.ItemNum,		0,	&arrCB[5]);
				
		BOOL bRet = i_pODBCStmt->ExecuteQuery((char*)(PROCEDURE_130828_0003));
		i_pODBCStmt->FreeStatement();
		if (!bRet)
		{
			char err[1024];
			sprintf(err, "ERROR line : MonsterIndex(%d) fMinDamege(%f) nMaxPerson(%d) nTime(%d) ItemNum(%d)!!", tmBossReward.MonsterIndex,tmBossReward.BossMonsterReward.fMinDamege,
				tmBossReward.BossMonsterReward.nMaxPerson,tmBossReward.BossMonsterReward.nTime,tmBossReward.BossMonsterReward.ItemNum);
			MessageBox(NULL, err, "ti_BossReward", MB_OK);
			return -3;
		}
		nObjects++;
		SendMessage(hWnd, WM_PROGRESSBAR_POS, 0, nObjects);
...
BOOL CAtumDBHelper::GetChannelingServerInfo(CODBCStatement *i_pODBCStmt, vectChannelingServerInfo *o_vectCHANNELING_SERVER_INFO)
{
	...
	BOOL bRet = i_pODBCStmt->ExecuteQuery((char*)(PROCEDURE_140217_0001));
	if (!bRet)
	{
		// clean up
		i_pODBCStmt->FreeStatement();
	...
	while ( (bRet = SQLFetch(i_pODBCStmt->m_hstmt)) != SQL_NO_DATA)
	{
		SCHANNELING_SERVER_INFO* temp = new SCHANNELING_SERVER_INFO;
		STRNCPY_MEMSET(&(temp->cChannelingServerToken),&(tempChannelingInfo.cChannelingServerToken), 2);	
		STRNCPY_MEMSET(temp->ChannelingServerName,tempChannelingInfo.ChannelingServerName, sizeof(tempChannelingInfo.ChannelingServerName));
		temp->nChannelingSeverUID		= tempChannelingInfo.nChannelingSeverUID;		
		o_vectCHANNELING_SERVER_INFO->push_back(temp);
	}
	i_pODBCStmt->FreeStatement();	// clean up
	return TRUE;
}
// 2014-02-10 by jhseol&bckim, 체널링
