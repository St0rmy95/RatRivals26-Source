...
#if RAT_SQL
			// Store the last error information
			strcpy_s(m_szLastSqlState, MAXDBMSGBUFLEN, (const char*)plm_szSqlState);
			m_nLastNativeError = (int)plm_pfNativeError;
			strcpy_s(m_szLastErrorMsg, MAXDBMSGBUFLEN, (const char*)plm_szErrorMsg);
#endif
