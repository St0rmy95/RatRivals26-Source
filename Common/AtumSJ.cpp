...
// 2005-12-02 by cmkwon, 주석처리	ret.pfm_SKILL_HYPERMOVING			= pfm_SKILL_HYPERMOVING				+ rhs.pfm_SKILL_HYPERMOVING;
	...
	ret.pfp_SKILL_BUFF_MON_ATTACK_POWER			= pfp_SKILL_BUFF_MON_ATTACK_POWER + rhs.pfp_SKILL_BUFF_MON_ATTACK_POWER; // 몬스터 공격시 - 공격력 증가 : Value 증가 %
	ret.pfp_SKILL_BUFF_MON_ATTACK_PROBABILITY	= pfp_SKILL_BUFF_MON_ATTACK_PROBABILITY + rhs.pfp_SKILL_BUFF_MON_ATTACK_PROBABILITY; // 몬스터 공격시 - 공격력 확율 : Value 증가 %
	ret.pfp_SKILL_BUFF_MON_ATTACK_PIERCE		= pfp_SKILL_BUFF_MON_ATTACK_PIERCE + rhs.pfp_SKILL_BUFF_MON_ATTACK_PIERCE; // 몬스터 공격시 - 피어스 증가 : Value 증가 %
	ret.pfp_SKILL_BUFF_MON_DEFENCE				= pfp_SKILL_BUFF_MON_DEFENCE + rhs.pfp_SKILL_BUFF_MON_DEFENCE; // 몬스터 방어시 - 방어력 증가 : Value 증가 %
	ret.pfp_SKILL_BUFF_MON_DEFENCE_AVOID		= pfp_SKILL_BUFF_MON_DEFENCE_AVOID + rhs.pfp_SKILL_BUFF_MON_DEFENCE_AVOID; // 몬스터 방어시 - 회피력 증가 : Value 증가 %
	ret.pfp_SKILL_BUFF_PVP_ATTACK				= pfp_SKILL_BUFF_PVP_ATTACK + rhs.pfp_SKILL_BUFF_PVP_ATTACK; // PVP - 공격력 증가 : Value 증가 %
	ret.pfp_SKILL_BUFF_PVP_ATTACK_PROBABILITY	= pfp_SKILL_BUFF_PVP_ATTACK_PROBABILITY	+ rhs.pfp_SKILL_BUFF_PVP_ATTACK_PROBABILITY;	// PVP - 명중률 증가 : Value 증가 %		// 2013-08-01 by jhseol, 역전의 버프 리뉴얼
	ret.pfp_SKILL_BUFF_PVP_ATTACK_PIERCE		= pfp_SKILL_BUFF_PVP_ATTACK_PIERCE		+ rhs.pfp_SKILL_BUFF_PVP_ATTACK_PIERCE;			// PVP - 피어스 증가 : Value 증가 %		// 2013-08-01 by jhseol, 역전의 버프 리뉴얼
	ret.pfp_SKILL_BUFF_PVP_DEFENCE				= pfp_SKILL_BUFF_PVP_DEFENCE			+ rhs.pfp_SKILL_BUFF_PVP_DEFENCE;				// PVP - 방어력 증가 : Value 증가 %		// 2013-08-01 by jhseol, 역전의 버프 리뉴얼
	ret.pfp_SKILL_BUFF_PVP_DEFENCE_PROBABILITY	= pfp_SKILL_BUFF_PVP_DEFENCE_PROBABILITY+ rhs.pfp_SKILL_BUFF_PVP_DEFENCE_PROBABILITY;	// PVP - 회피력 증가 : Value 증가 %		// 2013-08-01 by jhseol, 역전의 버프 리뉴얼
...
{
	int i; for(i=0; i < g_vectorALL_MAP_INFO.size(); i++)
	{
...
//	else if (IS_IN_RANGE(92, i_byLevel, 100))	return STRCMD_CS_CHARACTER_92_LEVEL_RANK;
	...
	else if (IS_IN_RANGE(116, i_byLevel, 120))	return STRCMD_CS_CHARACTER_116_LEVEL_RANK;
...
float CAtumSJ::GetAttackProbabilityC(ITEM *pItem, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, Stat_t i_nAttackPart, BYTE i_byLevel, enumAttackToTarget eAttackToTarget/*=NULL2NULL*/, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent	// 2013-05-09 by hskim, 세력 포인트 개선
{
	// 2010-02-19 by cmkwon, 100이하 레벨 최대스탯 수치 버그 수정 - 
...
#ifdef SC_UNBALANCED_FORCES_ADJUST_RATIO		// 2014-06-17 by bckim, 세력 불균형 ( 역전의 기회 WP획득량,몬스터 공격력확률,몬스터공격력)
		//( 역전의 기회 몬스터 공격력 확률 증가 )		
		if( 15.0f <= TURN_AROUND_BUFF_SKILL_100P_VALUE*i_PvPBuffPercent )		// 이것으로 		
		{
			AttackProb += 10.0f;		// + 10.0f
		}
#endif	// End. 2014-06-17 by bckim, 세력 불균형 ( 역전의 기회 WP획득량,몬스터 공격력확률,몬스터공격력)
...
#ifndef SC_UNBALANCED_FORCES_ADJUST_RATIO	// 2014-06-17 by bckim, 세력 불균형 ( 역전의 기회 WP획득량,몬스터 공격력확률,몬스터공격력)
...
float CAtumSJ::GetDefenseProbabilityC(CHARACTER *pCharacter, ITEM *pDefenseItem, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, enumAttackToTarget eAttackToTarget/*=NULL2NULL*/, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent	// 2013-05-09 by hskim, 세력 포인트 개선
...
//			+ (bIsPrimaryAttack?pParamFactor->pfp_DEFENSEPROBABILITY_01:pParamFactor->pfp_DEFENSEPROBABILITY_02);
	...
	// 2013-05-09 by hskim, 세력 포인트 개선
	float DefenseProba = (GetDefenseProbabilityC_Rate(pCharacter->TotalGearStat.DodgePart, pCharacter->Level)) * PROB100_MAX_VALUE + (bIsPrimaryAttack?pParamFactor->pfp_DEFENSEPROBABILITY_01:pParamFactor->pfp_DEFENSEPROBABILITY_02);
	...
	{
// 2014-04-02 by jekim, 역전의 버프(전투력) PVP 방어력, 회피력 상한 10%로 변경
#ifdef SC_PVPBUFF_COMBAT_POWER_JEKIM_SSJUNG
		i_PvPBuffPercent=min(i_PvPBuffPercent,1666.66f);
#endif
// end 2014-04-02 by jekim, 역전의 버프(전투력) PVP 방어력, 회피력 상한 10%로 변경
...
float CAtumSJ::GetAttackC(CHARACTER *pCharacter, ITEM *pAttackItem, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, enumAttackToTarget eAttackToTarget/*= NULL2NULL*/, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent	// 2013-05-09 by hskim, 세력 포인트 개선
{
	// 2010-02-19 by cmkwon, 100이하 레벨 최대스탯 수치 버그 수정 - 인자추가(, BYTE i_byLevel)
	...
	if( IsMonsterTarget(eAttackToTarget) )
	{
		...
		if( 15.0f <= TURN_AROUND_BUFF_SKILL_100P_VALUE*i_PvPBuffPercent )		// 이것으로 
		{
			fMinAttackFactor += 0.1f;		// *  1.1 
			fMaxAttackFactor += 0.1f;		// *  1.1
		}
#endif	// End. 2014-06-17 by bckim, 세력 불균형 ( 역전의 기회 WP획득량,몬스터 공격력확률,몬스터공격력)
	}
...
float CAtumSJ::GetMinAttackC(CHARACTER *pCharacter, ITEM *pAttackItem, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, enumAttackToTarget eAttackToTarget, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent		// 2013-05-09 by hskim, 세력 포인트 개선
{
	float fMinAttackFactor = (bIsPrimaryAttack?pParamFactor->pfm_MINATTACK_01:pParamFactor->pfm_MINATTACK_02);
...
float CAtumSJ::GetMaxAttackC(CHARACTER *pCharacter, ITEM *pAttackItem, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, enumAttackToTarget eAttackToTarget, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent	// 2013-05-09 by hskim, 세력 포인트 개선
{
	float fMaxAttackFactor = (bIsPrimaryAttack?pParamFactor->pfm_MAXATTACK_01:pParamFactor->pfm_MAXATTACK_02);
...
float CAtumSJ::GetDefenseC(CHARACTER *pCharacter, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, enumAttackToTarget eAttackToTarget /*= NULL2NULL*/, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent	// 2013-05-09 by hskim, 세력 포인트 개선	
{
...
//	return GetDefenseC_DecreaseRate(pCharacter->TotalGearStat.DefensePart, pCharacter->Level)*PROB256_MAX_VALUE + (bIsPrimaryAttack?pParamFactor->pfp_DEFENSE_01:pParamFactor->pfp_DEFENSE_02);
	...
	float Damage = GetDefenseC_DecreaseRate(pCharacter->TotalGearStat.DefensePart, pCharacter->Level)*PROB100_MAX_VALUE + (bIsPrimaryAttack?pParamFactor->pfp_DEFENSE_01:pParamFactor->pfp_DEFENSE_02);

	// 2013-05-09 by hskim, 세력 포인트 개선
	if( IsMonsterAttacker(eAttackToTarget) )
	{
		Damage += pParamFactor->pfp_SKILL_BUFF_MON_DEFENCE;
	}
	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - 적용 방어력
	if( IsCharacterAttacker(eAttackToTarget) )
	{
// 2014-04-02 by jekim, 역전의 버프(전투력) PVP 방어력, 회피력 상한 10%로 변경
#ifdef SC_PVPBUFF_COMBAT_POWER_JEKIM_SSJUNG
...
#endif
// end 2014-04-02 by jekim, 역전의 버프(전투력) PVP 방어력, 회피력 상한 10%로 변경
		Damage += pParamFactor->pfp_SKILL_BUFF_PVP_DEFENCE;	// 일반적인 버프 효과

#ifndef SC_UNBALANCED_FORCES_ADJUST_RATIO		// 2014-06-17 by bckim, 세력 불균형 ( 역전의 기회 WP획득량,몬스터 공격력확률,몬스터공격력)
		Damage += TURN_AROUND_BUFF_SKILL_100P_VALUE*i_PvPBuffPercent;	// 세력포인트에 의한 버프효과
#endif
		
	}
	// end 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - 적용 방어력
	// end 2013-05-09 by hskim, 세력 포인트 개선
...
// 캐릭터의 초당 최소 공격력
float CAtumSJ::GetMinAttackPerSecondC(CHARACTER *pCharacter, ITEM *pAttackItem, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, enumAttackToTarget eAttackToTarget, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent 추가	// 2013-05-09 by hskim, 세력 포인트 개선
{
...
// 캐릭터의 초당 최대 공격력
float CAtumSJ::GetMaxAttackPerSecondC(CHARACTER *pCharacter, ITEM *pAttackItem, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, enumAttackToTarget eAttackToTarget, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent		// 2013-05-09 by hskim, 세력 포인트 개선
{
...
// 2012-10-12 by jhjang 해피 아워 경험치 보너스 시스템 리뉴얼
	...
	if(nPartyMemberCnts > 1)
	{
		return (float)(nPartyMemberCnts-1)*BONUS_EXP_RATE_PARTY_COUNT + BONUS_EXP_RATE_PARTY_DEFAULT;
	}
#else
...
const float CAtumSJ::GetBurningMapAddExperience(int level)
{
	level = max(1, level);
	level = min(CHARACTER_LEVEL_110, level);
...
{
	int i; for(i=0; g_arrItemKindString[i].byItemKind0 != ITEMKIND_UNKNOWN; i++)
	{
...
{
	int i; for(i=0; g_arrGearAutoStatValuePerLevel[i].AutoStatType1 != 0; i++)
	{
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
float CAtumSJ::GetAttackC_PierceAttackProbability(Stat_t i_nAttackPart, ITEM *pAttackItem, CParamFactor *pParamFactor, BOOL bIsPrimaryAttack, BYTE i_byLevel, enumAttackToTarget eAttackToTarget /*=NULL2NULL*/, float i_PvPBuffPercent)	// 2013-08-01 by jhseol, 역전의 버프 리뉴얼 - i_PvPBuffPercent	// 2013-05-09 by hskim, 세력 포인트 개선
{
	// 2008-09-22 by dhjin, 신규 인첸트, 밑과 같이 수정
...
///////////////////////////////////////////////////////////////////////////////
/// \fn			
/// \brief		아이템 실 SPI가격을 리턴한다. (GetCityWarTex대용으로 사용)
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
INT64 CAtumSJ::GetItemSPIPrice(INT64 i_n64ItemPrice, float i_fTexPercent, float i_fHappyHourSale)
{	
	INT64 nSaleItemPrice = (INT64)(i_n64ItemPrice*(i_fHappyHourSale));	// 할인율 값
	INT64 nItemPrice = i_n64ItemPrice - nSaleItemPrice;							// 할인율 누적
	INT64 nTexPrice = (INT64)(nItemPrice*(i_fTexPercent/100.0f));				// 세금

	nItemPrice = nItemPrice + nTexPrice;				// 값에다 세금 누적
	nItemPrice = max(0, nItemPrice);

	return nItemPrice; // 실제 아이템 가격
}

///////////////////////////////////////////////////////////////////////////////
/// \fn			
/// \brief		아이템 실 WP가격을 리턴한다.
/// \author		// 2013-08-22 by bhsohn 해피아워 리뉴얼
/// \date		2013-08-23
/// \warning	
///
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
INT64 CAtumSJ::GetItemWPPrice(INT64 i_n64ItemPrice, float i_fHappyHourSale)
{	
	INT64 nItemPrice = i_n64ItemPrice ;
	nItemPrice -= (INT64)((i_n64ItemPrice*(i_fHappyHourSale)));
...
// 			}
	...
	case LANGUAGE_TYPE_ARGENTINA:	// 2010-11-01 by shcho, Lin 아르헨티나 서비스 시작 준비 - 언어타입 추가 스페인과 동일 적용
		{
			///////////////////////////////////////////////////////////////////////////////
			// 2009-06-04 by cmkwon, 지원 서비스 추가(Gameforge4D 폴란드어, 스페인어) - 현재는 영어와 숫자만 가능
...
//	case LANGUAGE_TYPE_JAPANESE:	// 일어		- 
	...
	case LANGUAGE_TYPE_SPANISH:		// 2009-06-04 by cmkwon, 지원 서비스 추가(Gameforge4D 폴란드어, 스페인어) - 
	case LANGUAGE_TYPE_INDONESIA:
	case LANGUAGE_TYPE_ARGENTINA:	// 2010-11-01 by shcho, Lin 아르헨티나 서비스 시작 준비 - 언어타입 추가
		break;
...
INT CAtumSJ::FindPartyFormationSkillNum(BYTE i_byFormationTy)
{
	...
	{
	// 2013-11-07 by bckim, 스킬 베이스넘버 적용(EP4-3)
#ifdef SC_SKILL_NUMBERING_RENEWAL_JHSEOL_BHSOHN	
		case FLIGHT_FORM_2_COLUMN:				return 7813150;		// 이렬 종대
		case FLIGHT_FORM_2_LINE:				return 7813090;		// 이렬 횡대
		case FLIGHT_FORM_TRIANGLE:				return 7813100;		// 삼각 편대
		case FLIGHT_FORM_INVERTED_TRIANGLE:		return 7813160;		// 역삼각 편대
		case FLIGHT_FORM_BELL:					return 7813110;		// 종 형태
		case FLIGHT_FORM_INVERTED_BELL:			return 7813130;		// 역종 형태
		case FLIGHT_FORM_X:						return 7813170;		// X자 형태
		case FLIGHT_FORM_STAR:					return 7813140;		// 별 형태	
#else
...
#endif
	// End. 2013-11-07 by bckim, 스킬 베이스넘버 적용(EP4-3)
	}
	return 0;
}
...
//	{115	,4745783611		,68754785572	,47220546	,51389}		// 2015-07-21 by bckim, 만렙 확장 ( 110 >> 115 )
...
const BURNING_MAP_LEVEL_ADD_EXPERIENCE arrBurningMapLevelAddExperience[] = 
{
	...
	{ 109,		100.0f },
	{ 110,		100.0f },
	{ 111,		100.0f },			// 2015-07-21 by bckim, 만렙 확장 ( 110 >> 115 )
	{ 112,		100.0f },			// 2015-07-21 by bckim, 만렙 확장 ( 110 >> 115 )
	{ 113,		100.0f },			// 2015-07-21 by bckim, 만렙 확장 ( 110 >> 115 )
	{ 114,		100.0f },			// 2015-07-21 by bckim, 만렙 확장 ( 110 >> 115 )
	{ 115,		100.0f },			// 2015-07-21 by bckim, 만렙 확장 ( 110 >> 115 )
	{ 116,		100.0f },
	{ 117,		100.0f },
	{ 118,		100.0f },
	{ 119,		100.0f },
