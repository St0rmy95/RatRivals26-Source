...
#pragma comment(lib, "Wininet.lib ")	// 2008-11-13 by cmkwon, 대만 Netpower_Tpe 빌링 시스템 구축 - 

#if defined(USING_MSXML)
	#import <msxml4.dll>				// 2008-10-08 by cmkwon, 대만 Netpower_Tpe 외부인증 구현 - 
	using namespace MSXML2;				// 2008-10-08 by cmkwon, 대만 Netpower_Tpe 외부인증 구현 - 
#endif
...
#if defined(USING_MSXML)
	IXMLDOMDocument2Ptr m_pIXMLDOMDoc;
	BOOL				m_bIsXMLLoaded;
#endif
