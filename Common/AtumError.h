...
#define ERR_PROTOCOL_ATTACHED_ITEM								0x2631		// 장착중인 아이템이다. // 2013-11-25 by jhseol&bckim, 거래소 - Error 추가

// 2014-04-10 by bckim, 거래소 예외처리 추가 
#define ERR_PROTOCOL_STATUS_INFORMATION_NOT_CORRECT				0x2632		// 거래소 현황과 값이 일치 하지 않음. 현황리스트 갱신 요함 
// End. 2014-04-10 by bckim, 거래소 예외처리 추가 
...
#define ERR_PROTOCOL_REQ_INFLUENCE_BALANCED						0x2660		// 2014-06-10 by ymjoo 세력 변경 아이템
#define ERR_PROTOCOL_REQ_ACCOUNT_REQUIREMENTS_NOT_MATCHED		0x2661		// 2014-06-10 by ymjoo 세력 변경 아이템
...
#define ERR_PROTOCOL_QUEST_FREEPASS_CANNOT_BE_USED				0x2717		// 아이템을 사용할수 없는 퀘스트.
#define ERR_PROTOCOL_QUEST_FREEPASS_NOT_LEVEL_IN_RANGE			0x2718		// 아이템을 사용할수 있는 퀘스트 레벨이 아님. 
