...
//	*o_pDBQuery		= *itr;
	memcpy(o_pDBQuery, &*itr, sizeof(DB_QUERY));		// 2013-11-25 by jhseol&bckim, 거래소 - 거래소 작업하다 간헐적으로 서버 죽는 문제 수정
...
//	case QT_GuildGetGuildMark:						return "QT_GuildGetGuildMark";
	...
	case QT_InsertCombatPowerLog:					return "QT_InsertCombatPowerLog";	// 2014-03-14 by jekim, 전투력 로그 추가
