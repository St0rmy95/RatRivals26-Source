...
// 1 - Command handled at the FieldServer
	...
	#define STRCMD_CS_COMMAND_MENT_HELP					"format: /ment [|String] - Setting character's ment"
	...
	#define STRCMD_CS_COMMAND_USERSEND_HELP				"format: /senduser [character name] [map name] - Moves the character into the specific map"
	...
	#define STRCMD_CS_COMMAND_REPAIRALL_HELP			"format: /repairAll [|character name] - Healing HP, UTC, FUEL to 100%, Healing yourself without [character name]"
...
//	#define STRCMD_CS_COMMAND_CITYWAR_HELP				"format: /citywar [start|finish]"
	...
	#define STRCMD_CS_COMMAND_RETURNALL_HELP			"format: /returnAll [MapIndex] - All the members in the guild are moved to the specific map"
...
// 2 - Command used in IMServer, some are used with the same command as the above
	...
	#define STRCMD_CS_COMMAND_DEBUGPRINTMSGI_HELP		"format: /msgi - Shows all the protocols that a client and the IM server sends and receives"
...
// 4 - CommonGameServer
	...
	#define STRCMD_CS_STATUS_MASTER_GENERAL			"full general"

	#define STRCMD_CS_ITEMKIND_AUTOMATIC			"Automatic type"
	#define STRCMD_CS_ITEMKIND_VULCAN				"Valkan type"
	...
	#define STRCMD_CS_ITEMKIND_DEFENSE				"Defence equipment type"
	#define STRCMD_CS_ITEMKIND_SUPPORT				"Support equipment type"
	#define STRCMD_CS_ITEMKIND_ENERGY				"Energy type"
	#define STRCMD_CS_ITEMKIND_INGOT				"Mineral type"
	#define STRCMD_CS_ITEMKIND_CARD					"Standard Card type"
	#define STRCMD_CS_ITEMKIND_ENCHANT				"Upgrade Card Type"
	...
	#define STRCMD_CS_ITEMKIND_PREVENTION_DELETE_ITEM	"Upgrade Delete Prevention Card type"
	...
	#define STRCMD_CS_ITEMKIND_ACCESSORY_UNLIMITED	"Unlimited Accessory"		// 2006-03-17 by cmkwon, »ç¿ë½ð£ÀÌ <¿µ¿ø>ÀÎ ¾¼¼­¸® ¾ÆÀÌÅÛ
	#define STRCMD_CS_ITEMKIND_ACCESSORY_TIMELIMIT	"Time limit Accessory"		// 2006-03-17 by cmkwon, »ç¿ë½ ½ð£ ÇÑÀÌ ÀÂ ¾¼¼­¸® ¾ÆÀÌÅÛ
	...
	#define STRCMD_CS_ITEMKIND_SKILL_DEFENSE		"Defence skill"
	...
	#define STRCMD_CS_AUTOSTAT_TYPE_MGEAR_DEFENSE	"Defence type"
...
//	#define STRCMD_CS_INFLUENCE_TYPE_ANI			"Arlington city regular army"
	...
	#define STRCMD_CS_POS_ACCESSORY_UNLIMITED		"Attachment (right rear side - fueltank | container)"

	// 2010-06-15 by shcho&hslee Æê½ýºÅÛ
	//#define STRCMD_CS_POS_PET						"»ç¿ë¾ÈÇÔ(ÈÌ ÁÂÃø)"
	#define STRCMD_CS_POS_ACCESSORY_TIME_LIMIT		"Not usable (left rear side)"

	#define STRCMD_CS_POS_PET						"Partner"

    #define STRCMD_CS_HIDDEN_ITEM					"Hidden position"		// 2011-09-20 by hskim, ÆÊ ½ýºÅÛ 2Â÷ - ¼û°ÜÁø ¾ÆÀÌÅÛ
...
//	#define STRCMD_CS_COMMAND_COMEONINFL_HELP		"format: /ComeOnNation [1(Normal)|2(BCU)|4(ANI)|3|5|6|7] [MAX_USER] [0|Min-level] [0|Max-level] [message to users] - Summons all specified level users in nation with a message."
	...
	#define STRCMD_CS_COMMAND_ITEMINMAP_HELP		"format: /SendItem [1(Normal)|2(VCN)|4(ANI)|3|5|6|7] [Item Number] [# of items] - Gives specific item to all the nation's users at the current map."
	...
	#define STRCMD_C_COMMAND_CALL_HELP					"format: /call [CharacterName] - Request 1:1 voice chat to specific character."
	...
	#define STRCMD_C_COMMAND_GUILDCALL_HELP				"format: /brigcall - Start voice chat between brigade members. Only usable by the brigade leader."
	#define STRCMD_C_COMMAND_GUILDCALLEND				"/brigcallend"
	#define STRCMD_C_COMMAND_GUILDCALLEND_HELP			"format: /brigcallend - End voice chat between brigade members. only usable by the brigade leader."
	#define STRCMD_C_COMMAND_CALLEND					"/endcall"
	#define STRCMD_C_COMMAND_CALLEND_HELP				"format: /endcall - Ends brigade, formation, or normal voice chat."
	...
	#define STRCMD_C_COMMAND_INITCHAT_HELP				"format: /initchat -  Resets chat window"
	...
	#define STRMSG_C_050810_0001_HELP					"format: /Closewindow -  Prevents message popups. Messages are automatically cancelled."
...
#define STRCMD_CS_COMMAND_STRATEGYPOINTINFO_HELP		"format: /StrategyPointInfo - This shows the status of current progress on the strategic point."
...
#define STRMSG_CS_COMMAND_ARENA_TEAM_INFO_HELP  "format: /arena [2(VCN)|4(ANI)]- Shows the present progress of arena."
...
#define STRCMD_071005_0001					"%d Year %d month %d day", Year, Month, Day //Year, Month, Day is parameter name. No need to translate.
...
#define STRCMD_CS_COMMAND_ITEMALLUSER_HELP                               "format: /ItemAllUser [1(Normal)|2(BCU)|4(ANI)|255(All)] [Item Number] [# of items] - Logged on user of selected nation will receive the the designated item"
...
#define STRCMD_CS_ITEMKIND_ALL_ITEM							"All kinds"

//////////////////////////////////////////////////////////////////////////
// 2008-05-20 by dhjin, EP3 - ¿©´Ü ¼ö »çÇ×	// 2006-03-07 by cmkwon
#define STRCMD_CS_GUILD_RANK_PRIVATE_NULL		"Member"
#define STRCMD_CS_GUILD_RANK_COMMANDER			"Flight brigade commander"
#define STRCMD_CS_GUILD_RANK_SUBCOMMANDER		"Co-brigade leader"				// 2008-05-20 by dhjin, EP3 - ¿©´Ü ¼ö »çÇ×
#define STRCMD_CS_GUILD_RANK_SQUAD_LEADER_1		"1st battalion commander"
#define STRCMD_CS_GUILD_RANK_PRIVATE_1			"1st battalion member"
#define STRCMD_CS_GUILD_RANK_SQUAD_LEADER_2		"2nd battalion commander"
#define STRCMD_CS_GUILD_RANK_PRIVATE_2			"2nd battalion member"
...
#define STRMSG_080821_0001				"Cannot assign rank to selected character."
...
#define STRCMD_CS_COMMAND_CHANGE_StartCityMapIndex_0                               "/Start City Map"
#define STRCMD_CS_COMMAND_CHANGE_StartCityMapIndex_1                               "Start City"
#define STRCMD_CS_COMMAND_CHANGE_StartCityMapIndex_HELP                           "format: /Start City [2001|2002][|Character name] - Select you character's home town on 2001 or 2002 when the nation has been set."
...
#define       STRCMD_CS_CHARACTER_108_LEVEL_RANK            "Major General"
...
#define STRCMD_CS_COMMAND_PARTYMEMBER_INFO_HELP			"format: /formationinfo [CharacterName] -information about a player's formation members (members must be logged into the game)"
