...
//	#define STRCMD_CS_COMMAND_COMEONINFL_HELP		"format: /ComeOnInfl [1(Normal)|2(VCN)|4(ANI)|255(All)] [최대인원] [0|최소레벨] [0|최대레벨] [유저에게 보내는 메시지] - 임의의 지정한 세력, 지정한 레벨의 유저들에게 이벤트맵으로 이동을 요청한다"
	...
	#define STRCMD_CS_COMMAND_MARKET_ACTIVATION_1		"/마켓"	
	#define STRCMD_CS_COMMAND_MARKET_ACTIVATION_HELP	"format: /마켓 - 거래소 ON OFF. "
...
#define STRCMD_CS_COMMAND_RESET_REVERSAL_BUFF_TIME		"/역전의기회시간리셋"
#define STRCMD_CS_COMMAND_RESET_REVERSAL_BUFF_STATE		"/역전의기회상태"
#define STRCMD_CS_COMMAND_RESET_REVERSAL_BUFF_EXECUTE	"/역전의기회실행"
#define STRCMD_CS_COMMAND_RESET_REVERSAL_BUFF_END		"/역전의기회종료"
#define STRCMD_CS_COMMAND_COMPAT_POWER					"/전투력"
...
#define STRCMD_CS_COMMAND_PARTYMEMBER_INFO_0			"/편대원정보"
#define STRCMD_CS_COMMAND_PARTYMEMBER_INFO_1			"/formationinfo"
#define STRCMD_CS_COMMAND_PARTYMEMBER_INFO_HELP			"format: /편대원정보 [CharacterName] - 해당유져가 속해있는 편대원정보(해당케릭터는 접속중이여야함)"
